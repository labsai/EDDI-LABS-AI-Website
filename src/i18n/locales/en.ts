...
const en = {
	...
	home: {
		...
		// Cloud section
		cloudBadge: 'Cloud',
		cloudTitle: 'EDDI Cloud',
		cloudSubtitle: 'Your dedicated EDDI instance on Google Cloud — deployed in minutes, fully managed.',
		cloudMonthlyLabel: 'Monthly',
		cloudMonthlyPrice: '€99',
		cloudMonthlyPeriod: '/month',
		cloudMonthlyCta: 'Get started',
		cloudYearlyLabel: 'Yearly',
		cloudYearlyPrice: '€79',
		cloudYearlyPeriod: '/month',
		cloudYearlyBilled: 'Billed €948 / year',
		cloudYearlyCta: 'Get started',
		cloudSaveBadge: 'Save 20%',
		cloudFeature1: 'Dedicated EDDI instance on Google Cloud',
		cloudFeature2: 'Up to 1M API requests / month',
		cloudFeature3: 'Automatic updates & daily backups',
		cloudFeature4: 'Custom domain support',
		cloudFeature5: 'Email support (24 h response)',
		cloudAlreadyCustomer: 'Already a customer?',
		cloudSignIn: 'Sign in to your dashboard →',
	},
