...
// ─── New Feature Pages ────────────────────────────────────
		...
		trust: {
			...
			timeline: [
				...
				{ year: '2008', text: 'Incubado en una <strong>incubadora de empresas universitaria</strong> con supervisión académica, enfocado en ingeniería de nivel investigación y desarrollo de producto sostenible.' },
				{ year: '2018', text: 'Seleccionado para un <strong>programa de aceleración europeo de primer nivel</strong> \u00b7 Lanzado como código abierto bajo Apache 2.0.' },
			...
			instFFGTitle: 'Subvención de investigación gubernamental',
			instFFGDesc: 'EDDI fue desplegado en <strong>SecLearn</strong>, una iniciativa nacional de formación en ciberseguridad financiada por una agencia de investigación gubernamental, en colaboración con un instituto nacional de investigación tecnológica.',
			...
			instWexDesc: 'Seleccionado para el <strong>Batch II</strong> de un <strong>acelerador de innovación europeo líder</strong>, conectando LABS.AI con socios empresariales y validando la viabilidad comercial de la plataforma.',
			instInitsTitle: 'Incubadora universitaria',
			instInitsDesc: 'Incubado en una <strong>incubadora de empresas universitaria</strong>, con apoyo institucional en fase temprana priorizando el rigor académico y la modelización empresarial sostenible.',
