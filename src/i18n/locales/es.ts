...
// ─── New Feature Pages ────────────────────────────────────
		...
		trust: {
			title: 'Trayectoria',
			description: 'EDDI está respaldado por investigación financiada por gobiernos, desplegado en producción empresarial y validado por instituciones académicas europeas — con certificaciones OpenSSF, Codacy y Red Hat.',
			heroTitle: 'Calidad empresarial.',
			heroHighlight: 'Probado por la comunidad.',
			heroDesc: 'EDDI no es un proyecto de fin de semana. Está respaldado por <strong>investigación financiada por gobiernos</strong>, desplegado en <strong>producción empresarial</strong> y validado por <strong>instituciones académicas europeas</strong>.',
			statPulls: 'Docker Pulls',
			statTests: 'Tests \u00b7 0 Fallos',
			statProviders: 'Proveedores LLM',
			statCertified: 'Certificado Red Hat',
			timelineTitle: 'De Viena al mundo',
			timelineDesc: 'Casi dos décadas de ingeniería continua — mucho antes de la era LLM.',
			timeline: [
				{ year: '2006', text: '<strong>Proyecto fundado</strong> en Viena, Austria — investigación temprana en gestión de diálogos y estado conversacional.' },
				{ year: '2008', text: 'Incubado en <strong>inits.at</strong>, la incubadora de empresas universitaria de Viena, con rigor académico y apoyo institucional.' },
				{ year: '2018', text: 'Seleccionado para el acelerador <strong>weXelerate Batch II</strong> \u00b7 Lanzado como código abierto bajo Apache 2.0.' },
				{ year: '2018', text: 'Primer <strong>EDDI Chatbot Hackathon</strong> en weXelerate, Viena — patrocinado por weXelerate y T-Mobile.' },
			...
			instFFGTitle: 'Agencia Austriaca de Promoción de la Investigación (FFG)',
			instFFGDesc: 'EDDI fue desplegado en <strong>SecLearn</strong>, una iniciativa nacional de formación en ciberseguridad financiada por la FFG, en colaboración con el Austrian Institute of Technology (AIT).',
			...
			instWexDesc: 'Seleccionado para el <strong>Batch II</strong> del principal hub de innovación de Europa Central, conectando LABS.AI con socios empresariales y validando la viabilidad comercial de la plataforma.',
			instInitsTitle: 'Incubadora inits.at',
			instInitsDesc: 'Incubado en la incubadora de empresas universitaria de Viena, con apoyo institucional en fase temprana priorizando el rigor académico y la modelización empresarial sostenible.',
