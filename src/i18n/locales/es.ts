...
const es: TranslationSchema = {
	...
	nav: {
		...
		codeQualityDesc: 'Más de 9.000 pruebas, cero fallos, >90% de cobertura',
	...
	home: {
		...
		heroTagline:
			`La plataforma de código abierto lista para producción para desplegar sistemas de IA multi-agente gobernados. Basada en configuración, autoalojada y lista para cumplimiento — con UI de gestión visual, 65 herramientas MCP y seguridad empresarial integrada. Ahora en <strong>${EDDI_VERSION}</strong> (latest: ${EDDI_LATEST_VERSION}).`,
		...
		faq7A: 'Las plataformas de IA en la nube ofrecen infraestructura gestionada pero crean <strong>dependencia del proveedor</strong>. EDDI funciona donde sea que funcione Docker. Consulta nuestra <a href="/enterprise/vs-alternatives/">comparación detallada</a>.',
	...
	featuresOverview: {
		...
		cqCardDesc:
			'<strong>Más de 9000 pruebas sin fallos.</strong> >90% de cobertura de código. Cero avisos de Checkstyle. CI/CD aplicado en cada merge.',
	...
	pages: {
		...
		security: {
			...
			crisisPara: 'El ecosistema de agentes de IA está bajo una presión de seguridad sin precedentes.',
		...
		performance: {
			...
			benchPara: 'Ningún runtime gana en todos los escenarios. Java supera consistentemente a Node.js en un 30–68%.',
			benchPara2: 'La arquitectura de EDDI está optimizada para cargas mixtas de I/O + CPU.',
		...
		codeQuality: {
			...
			description:
				'Más de 9000 pruebas sin fallos. >90% de cobertura de código. Cero avisos de Checkstyle. Compuertas de calidad CI/CD aplicadas en cada merge.',
			...
			items: [
				'<strong>Más de 9000 pruebas</strong> — Cobertura unitaria, de integración y de extremo a extremo',
		...
		whyEddi: {
			...
			roiPara: 'El valor de EDDI se mide en <strong>lo que los equipos no tienen que construir</strong>.',
			roiPara2: 'Para industrias reguladas: la alternativa es una implementación de cumplimiento personalizada que cubra más de 15 marcos regulatorios.',
