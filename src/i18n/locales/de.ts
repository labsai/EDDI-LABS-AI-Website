...
const de: TranslationSchema = {
	meta: {
		siteTitle: 'EDDI',
		siteDescription:
			`EDDI ${EDDI_VERSION}: Enterprise-Plattform für KI-Agenten-Orchestrierung. Selbst gehostetes, konfigurationsgesteuertes Multi-Agent-System mit visueller Management-UI, 84 MCP-Tools, Security-First-Architektur und integrierter regulatorischer Compliance für DSGVO, EU AI Act, HIPAA und 15+ weitere Rahmenwerke.`,
	},
	nav: {
		features: 'Features',
		docs: 'Docs',
		...
		mcpServerDesc: '84 Tools für KI-native Steuerung',
		...
		multiAgentDesc: 'Gruppenzusammenarbeit & Intent-Routing',
		observability: 'Observability',
		observabilityDesc: 'Pipeline-Logs & Audit-Trails',
		codeQuality: 'Code-Qualität',
		codeQualityDesc: '20.000+ Tests, null Fehler, >90% Coverage',
		aiReady: 'AI-Ready',
		...
		rag: 'RAG',
		ragDesc: '7 Embedding-Provider, 6 Vektorspeicher',
		...
		humanInTheLoopDesc: `Freigaben, Timeouts, Slack-Abzeichnung`,
		...
		mcpServerMobile: 'MCP Server (84 Tools)',
	...
	common: {
		...
		bannerText: 'Workspaces pro Benutzer, Connections für kontrollierten ausgehenden Zugriff und ein Red-Hat-zertifiziertes UBI-10-Image',
	...
	footer: {
		...
		tests: '20.000+ Tests · Null Fehler',
	...
	home: {
		...
		sol6Desc:
			'Intent-basierte Agent-Discovery, verwaltete Konversationen und <strong>Gruppenzusammenarbeit</strong>: Agents beraten sich in sieben Stilen, stimmen ab, bearbeiten gemeinsam geteilte Arbeitsergebnisse und geben Menschen einen Platz am Tisch.',
		trustedTitle: 'Vertrauenswürdig & Zertifiziert',
		trustRedHat: 'Red Hat Certified Container',
		trustRedHatDesc: 'Zertifiziertes Image, veröffentlicht im Red-Hat-Katalog',
		trustApache: 'Apache 2.0 Lizenz',
		trustApacheDesc: '100 % Open Source & Enterprise-ready',
		trustTests: '20.000+ Tests · 0 Fehler',
		...
		faq8Q: 'Funktioniert EDDI mit Open WebUI und anderen OpenAI-kompatiblen Clients?',
		faq8A: 'Ja. EDDI enthält eine OpenAI-kompatible <code>/v1</code>-API, die deployte Agenten als Modelle bereitstellt, sodass Open WebUI, das <code>openai</code>-SDK, LangChain und LiteLLM direkt mit ihnen kommunizieren können. Die API unterstützt Streaming und die Ausgabe der Token-Nutzung, führt jeden Chat in einer eigenen Konversation, und die Freigabe-Gates des Agenten gelten weiterhin. Sie ist standardmäßig deaktiviert und hat eine eigene Authentifizierung per API-Key.',
		faq9Q: 'Können mehrere Benutzer und Teams eine EDDI-Instanz gemeinsam nutzen?',
		faq9A: 'Ja. Workspaces pro Benutzer geben jedem Agenten und jeder Konfiguration einen Eigentümer, einen persönlichen oder Team-Workspace, der Keycloak-Gruppen zugeordnet ist, und explizites Teilen mit Nutzungs-, Lese-, Bearbeitungs- oder Eigentümerrechten. Über Connections rufen Agenten externe Systeme mit einem organisationsweiten Schlüssel, einem Service-Account oder dem eigenen OAuth-Konto jedes Benutzers auf, sodass ein Agent auf das beschränkt werden kann, was die Person, die ihn nutzt, tun darf. Workspaces sind optional, und bestehende Ressourcen werden beim Aktivieren rückwirkend zugeordnet, damit nichts verschwindet.',
		demoBtn: 'Demo-System',
	...
	gettingStarted: {
		...
		prereq1: '<strong>Docker</strong> (empfohlen) oder Java 25+. Auf x86-64-Hosts benötigt das EDDI-Image eine x86-64-v3-CPU (Intel Haswell, AMD Excavator oder neuer)',
		...
		step1Desc: 'Der schnellste Weg, EDDI zum Laufen zu bringen, ist das <strong>Ein-Befehl-Installationsskript</strong>. Es richtet EDDI + Ihre Wahl der Datenbank über Docker Compose ein, generiert einen Vault-Verschlüsselungsschlüssel und führt Sie durch die Konfiguration:',
		...
		step1ComposeOllama: 'Sie möchten ein lokales Modell? Fügen Sie das Ollama-Overlay hinzu, dann starten neue Agents mit vorausgefüllter Ollama-Base-URL:',
		step1After: 'EDDI ist unter <code>http://localhost:7070</code> erreichbar.',
		step2Title: '2. Via MCP verbinden',
		step2Desc:
			'Verbinden Sie Ihren KI-Assistenten mit EDDIs <strong>84 MCP-Tools</strong>. Die Konfiguration hängt von der Transport-Unterstützung Ihres Clients ab:',
		...
		step4Operator: 'Lieber im Gespräch oder per Formular? Eine neue Installation startet ohne deployte Agents. Öffnen Sie den <strong>Platform Operator</strong> unter <code>http://localhost:7070/manage/operator</code> und beschreiben Sie den gewünschten Agenten, wobei jede Änderung auf Ihre Freigabe wartet, oder füllen Sie den Agent-Assistenten unter <code>http://localhost:7070/manage/agents/wizard</code> aus.',
		...
		nextMcpServerDesc: 'Alle 84 MCP-Tools durchsuchen',
		...
		installerFlags: [
			...
			'<code>--with-monitoring</code>: Prometheus- und Grafana-Monitoring hinzufügen',
			'<code>--full</code>: Alles aktiviert (Datenbank + Auth + Monitoring)',
			`<code>--eddi-version=${EDDI_LATEST_VERSION}</code>: Ein bestimmtes EDDI-Release festlegen`,
	...
	useCases: {
		...
		devPlatformsDesc:
			'Interne KI-Services für Engineering-Teams, bereitgestellt als API- und MCP-zugängliche Agents, die sich nahtlos in CI/CD-Pipelines, Code-Review und Dokumentations-Workflows einfügen. Agents werden programmgesteuert mit einem einzigen setup_agent-Aufruf, vorhersagbaren CRUD-APIs und 84 MCP-Tools erstellt und verwaltet, sodass Coding-Agents in Claude, Cursor oder VS Code EDDI direkt steuern können, und über eine OpenAI-kompatible API stehen dieselben Agents auch in Open WebUI oder jedem OpenAI-Client zur Verfügung.',
	...
	featuresOverview: {
		...
		description:
			'Alle Fähigkeiten, die EDDI zum Enterprise-KI-Orchestrator machen, EDDI Manager UI, Config-as-Code, 84 MCP-Tools, Security-First-Architektur und mehr.',
		...
		mcpCardTitle: '🔌 MCP Server (84 Tools)',
		mcpCardDesc:
		...
		securityCardDesc:
			'Kein <code>eval()</code>, Vault-Integration, Path-Traversal-Schutz, OIDC/Keycloak, Workspaces pro Benutzer, <strong>kryptografische Audit-Trails</strong>.',
		...
		multiCardDesc:
			'Intent-basierte Discovery, verwaltete Konversationen und <strong>Gruppenzusammenarbeit</strong> mit Abstimmungen, gemeinsamen Artefakten und Menschen als Mitgliedern.',

		hitlCardTitle: `✋ Human-in-the-Loop`,
		hitlCardDesc: `Turn pausieren, einzelne Tool-Aufrufe freigeben lassen oder Diskussionsphasen abzeichnen. <strong>Freigabe-Workflows</strong> mit Timeout-Richtlinien, Slack-Karten und neustartsicherem Zustand.`,
		...
		ragCardTitle: '📚 RAG',
		ragCardDesc: '7 Embedding-Provider, 6 Vektorspeicher, httpCall RAG. <strong>Enterprise-Wissensabruf</strong> sofort einsatzbereit.',
		...
		cqCardDesc:
			'<strong>20.000+ Tests mit null Fehlern.</strong> Null Checkstyle-Warnungen. >90% Code-Coverage. CI/CD-Qualitätskontrolle bei jedem Merge.',
		aiCardTitle: '🧩 AI-Ready',
		aiCardDesc: '84 MCP-Tools, eine OpenAI-kompatible API, vorhersagbare CRUD-Patterns, selbstdokumentierende APIs. <strong>Für Coding-Agents entwickelt</strong>.',
	},
	pages: {
		manager: {
			title: 'EDDI Manager',
			...
			items: [
				...
				'<strong>Platform Operator & Agent-Assistent</strong>: Einen Agenten im Gespräch beschreiben oder ein Formular ausfüllen. Jede Änderung, die der Operator vorschlägt, wartet auf Ihre Freigabe',
				'<strong>Workspaces & Sharing</strong>: Workspace-Umschalter, ein Teilen-Dialog für jede Ressource, Eigentümer-Badges und Aktionen, die auf Ihre Berechtigungsstufe beschränkt sind',
				'<strong>Connections</strong>: Verbindungen zu externen Systemen erstellen und bearbeiten sowie eigene OAuth-Konten verknüpfen',
			],
		...
		mcpServer: {
			...
			para1:
				'Das Model Context Protocol (MCP) ist ein offener Standard, der KI-Assistenten die Interaktion mit externen Tools ermöglicht. EDDI implementiert einen umfassenden MCP-Server mit <strong>84 Tools</strong>, die jeden Aspekt der Plattform abdecken.',
			heading2: 'Tool-Kategorien',
			items: [
				'<strong>Konversations-Tools (13)</strong>: Mit Agents chatten, Konversationen verwalten, Verlauf lesen, Pipeline-Logs und Audit-Trail pro Aufgabe, Agent-Discovery, intent-basierter verwalteter Chat',
				'<strong>Admin-Tools (29)</strong>: Deployen, Undeployen, Erstellen, Aktualisieren und Löschen von Agents, Ressourcen, Triggern, Zeitplänen sowie Slack- oder benutzerdefinierten Kanal-Integrationen',
				...
				'<strong>Gruppenkonversations-Tools (18)</strong>: Multi-Agenten-Diskussionen in 7 Stilen, vordefinierte Vorlagen, Rückfragen an einzelne Mitglieder, verschachtelte Gruppen und Backlogs für feste Teams',
				'<strong>Human-in-the-Loop-Tools (10)</strong>: Offene Freigaben auflisten und prüfen, pausierte Konversationen fortsetzen oder abbrechen, Gruppenphasen freigeben und den Beitrag eines menschlichen Mitglieds einreichen',
				...
				'<strong>Dokumentations-Tools (2)</strong>: EDDIs eigene Dokumentation lesen, die auch als MCP-Ressourcen und über REST bereitsteht',
		...
		configAsCode: {
			...
			para2:
				'EDDI verwaltet diese Konfigurations-Ressourcen: <strong>Regeln</strong> (System-Prompts), <strong>Workflows</strong> (Pipeline-Definitionen), <strong>LLM-Konnektoren</strong> (Anbieter-Einstellungen), <strong>HTTP-Konnektoren</strong> (externe API-Integrationen), <strong>Connections</strong> (wie sich EDDI gegenüber einem externen System authentifiziert), <strong>Gruppen</strong> (Multi-Agenten-Diskussionen), <strong>Agents</strong> (Deployment-Deskriptoren) und <strong>Environments</strong> (Deployment-Ziele).',
		},
		security: {
			...
			items: [
				...
				'<strong>OIDC/Keycloak</strong>: Enterprise-Authentifizierung und -Autorisierung mit RBAC-Rollen (Admin, Editor, Viewer) und einer eigenen Freigabe-Rolle',
				'<strong>Workspaces pro Benutzer</strong>: Jede Konfigurationsressource hat einen Eigentümer und einen persönlichen oder Team-Workspace und lässt sich explizit mit Nutzungs-, Lese-, Bearbeitungs- oder Eigentümerrechten teilen',
				'<strong>Connections</strong>: Ein einheitliches Credential-Modell für ausgehende Aufrufe, von organisationsweiten Schlüsseln und OAuth2-Service-Accounts bis zum eigenen OAuth-Konto jedes Benutzers oder einem Credential, das das aufrufende System pro Anfrage mitliefert. Secrets sind immer Vault-Referenzen',
				'<strong>Guardrails für Tool-Ergebnisse</strong>: Jedes Tool-Ergebnis ist mit seiner Herkunft gekennzeichnet, und anweisungsartiger Text darin wird markiert, geschwärzt, mit einer Warnung versehen oder blockiert, bevor das Modell darauf reagiert',
				...
				'<strong>SSRF-Schutz</strong>: URL-Validierung und Domain-Allowlisting verhindern Server-Side Request Forgery, und Cloud-Metadaten-Endpunkte werden als Ziele für HTTP-Aufrufe, MCP und A2A abgewiesen, auch über DNS-Auflösung und Weiterleitungen',
				...
				'<strong>Gehärtetes Base-Image</strong>: Per Digest fixierte Red Hat UBI 10 Runtime, veröffentlicht im Red-Hat-zertifizierten Katalog',
			],
		...
		performance: {
			...
			items: [
				...
				'<strong>SSE-Streaming</strong>: Echtzeit-Chat-Antworten, Gruppendiskussions-Feeds und Live-Log-Streaming über Server-Sent Events, mit Token-für-Token-Ausgabe auch während Tools laufen',
				'<strong>Ein-Befehl-Installation</strong>: Interaktiver Assistent stellt EDDI + Datenbank über Docker Compose bereit und generiert einen Vault-Schlüssel',
				'<strong>Red Hat Zertifiziert</strong>: UBI-10-Image, veröffentlicht im Red-Hat-zertifizierten Katalog, mit automatisierten Preflight-Checks in CI/CD',
			],
		...
		multiAgent: {
			...
			description:
				'Intent-basierte Agent-Discovery, verwaltete Konversationen und Gruppenzusammenarbeit: Agenten beraten sich, stimmen ab, teilen Arbeitsergebnisse und arbeiten mit Menschen zusammen.',
			...
			para2: 'EDDI unterstützt <strong>Multi-Agenten-Gruppenkonversationen</strong> mit 7 integrierten Diskussionsstilen, expliziten Abstimmungen, gemeinsamen Arbeitsergebnissen, festen Teams, verschachtelten Gruppenstrukturen, dynamischer Agent-Erstellung und einem Meta-Agenten, der die Plattform selbst bedient:',
			items2: [
				'<strong>7 Diskussionsstile</strong>: Runder Tisch, Peer Review, Advocatus Diaboli, Delphi, Debatte, <strong>Task Force</strong> (PLANEN → AUSFÜHREN → VERIFIZIEREN → SYNTHESE) und <strong>Verhandlung</strong> (Angebote, Zugeständnisse und ein Schlichter)',
				'<strong>Abstimmungen</strong>: Abstimmungsphasen sammeln explizite Stimmzettel (Mehrheits- oder Zustimmungswahl, gewichtet, mit Quorum) und protokollieren eine Entscheidung mit vollständiger Auszählung und der abweichenden Meinung der unterlegenen Seite',
				'<strong>Gemeinsame Artefakte & Aufgaben-Bidding</strong>: Mitglieder bearbeiten gemeinsam ein validiertes, geteiltes Arbeitsergebnis und bieten auf Aufgaben, statt reihum zugeteilt zu werden',
				'<strong>Menschen als Mitglieder</strong>: Eine Person kommt in der Diskussion selbst zu Wort, statt nur freizugeben',
				'<strong>Feste Teams</strong>: Dauerhafte Teams mit Backlog, Cron-Takt, einem Moderator mit begrenzten Handlungsoptionen und Retro-Phasen, die Team-Wissen sichern',
				'<strong>Vordefinierte Vorlagen</strong>: Research-Pod, Redaktionsteam, Ops-Task-Force, Entscheidungsgremium und Verhandlungstisch, sofort instanziierbar',
				...
				'<strong>Slack-Integration</strong>: Agenten in Slack-Kanäle deployen und Multi-Agenten-Debatten direkt in Threads führen, mit DM-Unterstützung, Trigger-Keyword-Routing und einem Beobachtungsmodus, in dem ein Agent einen Kanal verfolgt und nur antwortet, wenn ein Keyword oder Dateityp passt, unter Einhaltung von Cooldown, Tageslimit für Antworten und Tageslimit für Kosten',
		...
		observability: {
			...
			items: [
				...
				'<strong>Grafana-Dashboards</strong>: Ein vorgefertigtes Operations-Dashboard plus das Dashboard Full Metrics Reference mit einem Panel für jede registrierte Metrik',
		...
		codeQuality: {
			title: 'Code-Qualität',
			description:
				'20.000+ Tests mit null Fehlern. Null Checkstyle-Warnungen. >90% Code-Coverage. CI/CD-erzwungene Qualitätskontrolle bei jedem Merge.',
			...
			items: [
				'<strong>20.000+ Tests</strong>: Unit-, Integrations- und End-to-End-Coverage',
				...
				'<strong>MCP-Tool-Tests</strong>: Umfassende Coverage aller 84 MCP-Tools',
		...
		aiReady: {
			...
			description:
				'84 MCP-Tools, vorhersagbare CRUD-Patterns, selbstdokumentierende APIs. Von Grund auf für die Zusammenarbeit mit Coding-Agents entwickelt.',
			...
			items: [
				...
				'<strong>MCP-First</strong>: 84 Tools für KI-Assistenten-Integration entwickelt',
				'<strong>Setup-Automatisierung</strong>: Agent-Erstellung in einem Aufruf mit <code>setup_agent</code>',
				'<strong>OpenAI-kompatible API</strong>: Deployte Agenten erscheinen als Modelle in Open WebUI, im <code>openai</code>-SDK, in LangChain und LiteLLM',
				'<strong>Docs für Agenten</strong>: EDDIs Dokumentation ist über MCP und REST lesbar, sodass ein Agent nachschlagen kann, wie die Plattform funktioniert, bevor er handelt',
			],
		},
		memory: {
		...
		rag: {
			...
			description: '7 Embedding-Provider, 6 Vektorspeicher, httpCall RAG und asynchrone Dokumentenaufnahme, Enterprise-Wissensabruf für KI-Agenten.',
			...
			items: [
				...
				'<strong>6 Vektorspeicher</strong>: pgvector, Chroma, In-Memory, MongoDB Atlas, Elasticsearch, Qdrant',
		...
		humanInTheLoop: {
			...
			description: `Einen Turn pausieren, einzelne Tool-Aufrufe freigeben lassen oder Diskussionsphasen abzeichnen. Freigabe-Workflows mit Timeout-Richtlinien, Slack-Karten und neustartsicherem Zustand, ausgeliefert mit EDDI 6.2.0.`,
			heading1: `Autonomie mit Not-Aus`,
			para1: `Autonome Agenten sind genau bis zu dem Moment nützlich, in dem sie etwas Unumkehrbares tun. EDDI 6.2.0 führte <strong>Human-in-the-Loop-Governance</strong> ein: explizite Freigabe-Gates auf drei Granularitätsstufen, abgesichert durch Timeout-Richtlinien, Schleifenerkennung und einen Zustand, der Neustarts übersteht. Freigaben sind Konfiguration, kein eigener Anwendungscode.`,
			whyTitle: `Warum Freigabe-Gates in die Plattform gehören`,
			whyPara: `Die meisten Teams bauen Freigaben auf Anwendungsebene an: hier eine Queue, dort ein Webhook, irgendwo ein Datenbank-Flag. Dieser Ansatz bricht, sobald ein Prozess neu startet, eine freigebende Person offline geht oder ein Agent dieselbe Anfrage in einer Schleife wiederholt. EDDI verankert das Gate in der Konversations-Pipeline selbst. Ein pausierter Turn bleibt pausiert, konkurrierende Eingaben werden mit einem klaren <code>409 Conflict</code> abgewiesen, und jede Entscheidung landet im selben Audit-Trail wie der übrige Agenten-Lebenszyklus.`,
			heading2: `Drei Freigabe-Ebenen`,
			items: [
				`<strong>Freigabe auf Turn-Ebene</strong>: Eine <code>PAUSE_CONVERSATION</code>-Aktion hält die gesamte Pipeline an. Bis ein Mensch fortsetzt, liefern weitere Nutzereingaben <code>409 Conflict</code> zurück, damit nichts an der offenen Entscheidung vorbeiläuft.`,
				`<strong>Gating pro Tool-Aufruf</strong>: Einzelne Tool-Aufrufe können vor der Ausführung eine menschliche Freigabe verlangen. Allow- und Exempt-Listen mit Glob-Mustern legen exakt fest, was freigabepflichtig ist, über eingebaute, HTTP-, MCP-, A2A-, dynamische und Memory-Tools hinweg.`,
				`<strong>Freigabe von Gruppenphasen</strong>: Diskussionsphasen in Multi-Agent-Gruppen können eine menschliche Abzeichnung auf <code>PHASE</code>- oder <code>TASK</code>-Ebene verlangen, damit eine Gruppe nicht unbeaufsichtigt von der Planung in die Ausführung wechselt.`,
			],
			timeoutTitle: `Timeout-Richtlinien`,
			timeoutPara: `Menschen sind kein hochverfügbarer Dienst. Jedes Gate legt fest, was passiert, wenn niemand rechtzeitig reagiert:`,
			timeoutItems: [
				`<code>WAIT_INDEFINITELY</code>: Der Lauf bleibt pausiert, bis ein Mensch entscheidet. Für Aktionen, die niemals unbeaufsichtigt laufen dürfen.`,
				`<code>AUTO_APPROVE</code>: Nach Ablauf der Frist wird fortgesetzt. Passend für risikoarme Aktionen, bei denen Aufsicht eine Stichprobe ist und kein hartes Gate.`,
				`<code>AUTO_REJECT</code>: Die offene Aktion wird abgelehnt, der Agent setzt seinen Ablehnungspfad fort.`,
				`<code>ABORT</code>: Der Lauf wird sofort beendet, die sicherste Wahl für unumkehrbare Operationen mit großer Wirkung.`,
			],
			opsTitle: `Für den Produktivbetrieb gebaut`,
			opsPara: `Ein Freigabesystem wird an seinem schlechtesten Tag gemessen: ein Neustart mitten in der Prüfung, ein Agent, der dieselbe Frage immer wieder stellt, eine freigebende Person, die in Slack arbeitet statt in der Admin-UI.`,
			opsItems: [
				`<strong>No-Progress-Guard</strong>: EDDI bildet für jede Pause einen Fingerabdruck. Tauchen nach automatisierten Entscheidungen identische Fingerabdrücke erneut auf, erkennt EDDI eine endlose Freigabeschleife und durchbricht den Kreislauf, statt Tokens dafür zu verbrennen.`,
				`<strong>Crash Recovery</strong>: Offene Freigaben überstehen Serverneustarts, und Timeout-Timer werden automatisch neu gesetzt. Ein Rolling Deployment verliert damit nie stillschweigend eine laufende Entscheidung.`,
				`<strong>Slack-Freigaben</strong>: Interaktive Block-Kit-Karten bringen die Entscheidung zur freigebenden Person, mit redigierten Argumentvorschauen und Whitelists, damit nur autorisierte Personen auf eine Karte reagieren können.`,
				`<strong>MCP-Freigaben</strong>: Externe Clients listen offene Freigaben auf und genehmigen oder lehnen sie über MCP-Tools ab. Diese gehören zu den 84 Tools und machen IDE oder Agenten-Client zur Steuerungsebene.`,
				`<strong>Freigeben, was tatsächlich ausgeführt wird</strong>: Eine Freigabe ist an die aufgelöste Anfrage gebunden, und wer MCP- und A2A-Aufrufe freigibt, sieht das Ziel und einen Fingerabdruck der Anfrage, nicht nur einen Tool-Namen.`,
				`<strong>Ein abgesicherter Platform Operator</strong>: Der Platform Operator kann Agenten über EDDIs eigene API erstellen und ändern, und jeder Schreibversuch wartet an demselben Freigabe-Gate.`,
			],
			govTitle: `Governance und Compliance`,
			govPara: `Menschliche Aufsicht ist nicht nur eine betriebliche Präferenz, sondern eine regulatorische Anforderung. Freigabe-Gates geben der menschlichen Aufsicht nach Art. 14 EU AI Act eine konkrete Umsetzung: Eine namentlich bekannte Person genehmigt eine konkrete Aktion, und die Entscheidung wird protokolliert. Zusammen mit EDDIs <a href="/enterprise/compliance/">Compliance-Framework</a> und dem HMAC-SHA256-Audit-Trail lässt sich einer Prüfstelle nicht nur zeigen, was ein Agent getan hat, sondern auch, wer es wann erlaubt hat.`,
		},
		scheduling: {
		...
		whyEddi: {
			...
			items: [
				...
				'<strong>84 MCP-Tools</strong>: Vollständige KI-native Steuerung via Model Context Protocol',
				'<strong>Enterprise-Sicherheit</strong>: OIDC, Vault, Audit-Trails, kein eval()',
				'<strong>Von Grund auf mehrbenutzerfähig</strong>: Workspaces pro Benutzer mit Sharing und Connections, über die Agenten mit den eigenen Credentials jedes Benutzers handeln',
			...
			comparisonRows: [
				...
				{ dimension: 'Deployment', frameworks: 'pip/npm + manuelle Infrastruktur', eddi: 'Ein-Befehl Docker-Installation, Kubernetes/OpenShift-ready, Red-Hat-zertifiziertes Image' },
			],
			// LLM Providers
			...
			rfpItems: [
				...
				{ category: 'Integration', question: 'Können Agents externe Tools und Services über offene Standards nutzen?', eddiAnswer: '84 MCP-Tools, A2A-Protokoll, OpenAPI-3.1-Generierung/-Nutzung und OAuth 2.0/OIDC, alles offene Standards, plus eine OpenAI-kompatible API für jeden OpenAI-Client.' },
		...
		vsAlternatives: {
			...
			libraryComparisonRows: [
				...
				{ framework: 'EDDI', abstraction: 'Multi-Agenten-Orchestrierungsplattform', learning: 'Niedrig (Config-as-Code)', state: 'Natives persistentes Ged\u00e4chtnis, Dream-Konsolidierung, rollende Zusammenfassungen', production: 'Komplett paketiert: OIDC/Keycloak, Workspaces pro Benutzer, Vault, Audit-Trails, Management-UI, Kubernetes-ready' },
			],
		...
		compliance: {
			...
			euAiActItems: [
				...
				'<strong>Menschliche Aufsicht</strong>: Freigabe-Gates auf Turn-, Tool-Aufruf- und Gruppenphasen-Ebene, plus menschliche Überprüfung, Intervention und Notabschaltung in der Management-UI (Art. 14, Menschliche Aufsicht)',
		...
		trust: {
			...
			timeline: [
				...
				{ year: '2026', text: '<strong>v6</strong>: 84 MCP-Tools, A2A-Protokoll, 7 Diskussionsstile mit Abstimmungen und menschlichen Mitgliedern, Platform Operator, Workspaces pro Benutzer, OpenAI-kompatible API, Modell-Kaskadierung.' },
			...
			instRedHatDesc: 'Das Docker-Image von EDDI ist <strong>IBM/Red-Hat-zertifiziert</strong> und besteht automatisierte Preflight-Checks für Sicherheit, Stabilität und Enterprise-Deployment-Bereitschaft. Stabile Releases werden im Red-Hat-zertifizierten Katalog veröffentlicht.',
