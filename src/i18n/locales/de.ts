	...
	pages: {
		...
		mcpServer: {
			...
			items: [
				...
				'<strong>OpenAPI 3.1</strong> — Automatisch generierte OpenAPI-Spezifikation. Fügen Sie eine externe OpenAPI-Spec in EDDI ein → erhalten Sie einen vollständig bereitgestellten API-aufrufenden Agent',
			],
