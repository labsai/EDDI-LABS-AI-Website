...
// ─── New Feature Pages ────────────────────────────────────
		...
		trust: {
			...
			timeline: [
				{ year: '2006', text: '<strong>Projektgründung</strong> in Europa — frühe Forschung zu Dialogmanagement und konversationellem Zustand.' },
				{ year: '2008', text: 'Inkubiert in einem <strong>Universitäts-Gründerzentrum</strong> mit akademischer Betreuung, Fokus auf forschungsnahe Entwicklung und nachhaltige Produktentwicklung.' },
				...
				{ year: '2018', text: 'Erster <strong>EDDI Chatbot Hackathon</strong> — co-finanziert von einem Accelerator und einem großen Telekommunikationsanbieter.' },
			...
			instFFGTitle: 'Staatliche Forschungsförderung',
			instFFGDesc: 'EDDI wurde in <strong>SecLearn</strong> eingesetzt, einer nationalen Cybersicherheits-Trainingsinitiative, gefördert von einer staatlichen Forschungsagentur, in Zusammenarbeit mit einem nationalen Technologieforschungsinstitut.',
			...
			instWexDesc: 'Ausgewählt für <strong>Batch II</strong> eines <strong>führenden europäischen Innovationsbeschleunigers</strong>, der LABS.AI mit Unternehmenspartnern vernetzte und die kommerzielle Tragfähigkeit der Plattform validierte.',
			instInitsTitle: 'Universitäts-Inkubator',
			instInitsDesc: 'Inkubiert in einem <strong>Universitäts-Gründerzentrum</strong>, mit frühphasiger institutioneller Unterstützung, die akademische Strenge und nachhaltige Geschäftsmodellierung priorisierte.',
