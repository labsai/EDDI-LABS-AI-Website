...
// ─── New Feature Pages ────────────────────────────────────
		...
		trust: {
			title: 'Erfolgsbilanz',
			description: 'EDDI wird durch staatlich geförderte Forschung gestützt, in der Unternehmensproduktion eingesetzt und von europäischen akademischen Institutionen validiert — mit OpenSSF-, Codacy- und Red Hat-Zertifizierungen.',
			heroTitle: 'Enterprise-tauglich.',
			heroHighlight: 'Community-bewährt.',
			heroDesc: 'EDDI ist kein Wochenendprojekt. Es wird durch <strong>staatlich geförderte Forschung</strong> gestützt, in der <strong>Unternehmensproduktion</strong> eingesetzt und von <strong>europäischen akademischen Institutionen</strong> validiert.',
			statPulls: 'Docker Pulls',
			statTests: 'Tests \u00b7 0 Fehler',
			statProviders: 'LLM-Anbieter',
			statCertified: 'Red Hat-zertifiziert',
			timelineTitle: 'Von Wien in die Welt',
			timelineDesc: 'Fast zwei Jahrzehnte kontinuierliche Entwicklung — lange vor der LLM-Ära.',
			timeline: [
				{ year: '2006', text: '<strong>Projektgründung</strong> in Wien, Österreich — frühe Forschung zu Dialogmanagement und konversationellem Zustand.' },
				{ year: '2008', text: 'Inkubiert bei <strong>inits.at</strong>, dem Wiener Universitäts-Gründerzentrum, mit akademischer Strenge und institutioneller Unterstützung.' },
				{ year: '2018', text: 'Ausgewählt für den <strong>weXelerate Batch II</strong> Accelerator \u00b7 Als Open Source unter Apache 2.0 veröffentlicht.' },
				{ year: '2018', text: 'Erster <strong>EDDI Chatbot Hackathon</strong> bei weXelerate, Wien — gesponsert von weXelerate und T-Mobile.' },
			...
			instFFGTitle: 'Österreichische Forschungsförderungsgesellschaft (FFG)',
			instFFGDesc: 'EDDI wurde in <strong>SecLearn</strong> eingesetzt, einer nationalen Cybersicherheits-Trainingsinitiative, gefördert von der FFG, in Zusammenarbeit mit dem Austrian Institute of Technology (AIT).',
			...
			instWexDesc: 'Ausgewählt für <strong>Batch II</strong> des führenden Innovationshubs in Zentraleuropa, der LABS.AI mit Unternehmenspartnern vernetzte und die kommerzielle Tragfähigkeit der Plattform validierte.',
			instInitsTitle: 'inits.at Inkubator',
			instInitsDesc: 'Inkubiert am Wiener Universitäts-Gründerzentrum, mit frühphasiger institutioneller Unterstützung, die akademische Strenge und nachhaltige Geschäftsmodellierung priorisierte.',
