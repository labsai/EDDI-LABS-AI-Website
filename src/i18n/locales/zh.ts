...
const zh: TranslationSchema = {
	...
	featuresOverview: {
		...
		cqCardTitle: '🧪 代码质量',
		cqCardDesc: '<strong>1,500+测试，零失败。</strong>Checkstyle警告从697减少到0。CI/CD在每次合并时强制执行。',
		aiCardTitle: '🧩 AI就绪',
	...
	pages: {
		...
		codeQuality: {
			title: '代码质量',
			description: '1,500+测试，零失败。Checkstyle警告从697减少到0。CI/CD质量门禁在每次合并时强制执行。',
			heading1: '工程严谨',
			...
			items: [
				...
				'<strong>Checkstyle强制执行</strong> — 从697减少到0个警告',
