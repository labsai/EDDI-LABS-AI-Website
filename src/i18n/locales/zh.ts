...
// ─── New Feature Pages ────────────────────────────────────
		...
		trust: {
			...
			timeline: [
				{ year: '2006', text: '在欧洲<strong>项目成立</strong> — 对话管理和会话状态的早期研究。' },
				{ year: '2008', text: '在<strong>大学创业孵化器</strong>孵化，拥有学术监督、注重研究级工程和可持续产品开发。' },
				{ year: '2018', text: '入选<strong>欧洲顶级加速器项目</strong> \u00b7 以 Apache 2.0 许可开源发布。' },
				{ year: '2018', text: '首届 <strong>EDDI 聊天机器人黑客松</strong> — 由加速器和大型电信运营商联合赞助。' },
			...
			instFFGTitle: '政府研究资助',
			instFFGDesc: 'EDDI 在 <strong>SecLearn</strong> 中部署，这是由政府研究机构资助、与国家技术研究所合作的国家网络安全培训项目。',
			...
			instWexDesc: '入选<strong>欧洲领先的创新加速器</strong>，将 LABS.AI 与企业合作伙伴连接，验证平台的商业可行性。',
			instInitsTitle: '大学创业孵化器',
			instInitsDesc: '在<strong>大学创业孵化器</strong>孵化，获得早期机构支持，优先考虑学术严谨性和可持续商业建模。',
