...
// ─── New Feature Pages ────────────────────────────────────
		...
		trust: {
			title: '发展历程',
			description: 'EDDI 由政府资助的研究支持，在企业生产环境中部署，并经过欧洲学术机构验证 — 拥有 OpenSSF、Codacy 和 Red Hat 认证。',
			heroTitle: '企业级品质。',
			heroHighlight: '社区验证。',
			heroDesc: 'EDDI 不是一个周末项目。它由<strong>政府资助的研究</strong>支持，在<strong>企业生产环境</strong>中部署，并经过<strong>欧洲学术机构</strong>验证。',
			statPulls: 'Docker 拉取次数',
			statTests: '测试 \u00b7 0 失败',
			statProviders: 'LLM 提供商',
			statCertified: 'Red Hat 认证',
			timelineTitle: '从维也纳到世界',
			timelineDesc: '在 LLM 时代之前，近二十年的持续工程。',
			timeline: [
				{ year: '2006', text: '在奥地利维也纳<strong>项目成立</strong> — 对话管理和会话状态的早期研究。' },
				{ year: '2008', text: '在维也纳大学商业孵化器 <strong>inits.at</strong> 孵化，具有学术严谨性和机构支持。' },
				{ year: '2018', text: '入选 <strong>weXelerate Batch II</strong> 加速器 \u00b7 以 Apache 2.0 许可开源发布。' },
				{ year: '2018', text: '在维也纳 weXelerate 举办首届 <strong>EDDI 聊天机器人黑客松</strong> — 由 weXelerate 和 T-Mobile 赞助。' },
			...
			instFFGTitle: '奥地利研究促进署 (FFG)',
			instFFGDesc: 'EDDI 在 <strong>SecLearn</strong> 中部署，这是由 FFG 资助、与奥地利技术研究所 (AIT) 合作的国家网络安全培训计划。',
			...
			instWexDesc: '入选中欧领先创新中心的 <strong>Batch II</strong>，将 LABS.AI 与企业合作伙伴连接，验证平台商业可行性。',
			instInitsTitle: 'inits.at 孵化器',
			instInitsDesc: '在维也纳大学商业孵化器孵化，获得早期机构支持，优先考虑学术严谨性和可持续商业建模。',
