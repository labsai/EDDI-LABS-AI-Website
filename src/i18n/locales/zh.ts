...
const zh: TranslationSchema = {
	...
	home: {
		...
		faq1Q: '什么是EDDI？',
		faq1A:
			'EDDI是一个开源的企业级AI编排平台。它使团队能够使用JSON配置而非编译代码来构建、配置和部署AI代理。EDDI提供了一个完整的平台，包括<strong>生产就绪的React管理界面</strong>（EDDI管理器）、内置REST API、对话状态管理、安全性（OIDC/Keycloak）、不可变审计跟踪和48个MCP工具——所有这些都可通过Docker或Kubernetes部署。',
