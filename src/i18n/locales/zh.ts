...
const zh: TranslationSchema = {
	...
	featuresOverview: {
		...
		cqCardTitle: '🧪 代码质量',
		cqCardDesc: '<strong>2,000+测试，零失败。</strong>零Checkstyle警告。CI/CD在每次合并时强制执行。',
		aiCardTitle: '🧩 AI就绪',
	...
	pages: {
		...
		codeQuality: {
			title: '代码质量',
			description: '2,000+测试，零失败。零Checkstyle警告。CI/CD质量门禁在每次合并时强制执行。',
			heading1: '工程严谨',
			para1: 'EDDI通过全面测试、静态分析和CI/CD质量门禁维持<strong>卓越的代码质量</strong>。每个拉取请求必须通过完整的测试套件才能合并。',
			heading2: '质量指标',
			items: [
				'<strong>2,000+测试</strong> — 单元、集成和端到端覆盖',
