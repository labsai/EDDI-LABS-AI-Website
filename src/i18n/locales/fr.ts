...
// ─── New Feature Pages ────────────────────────────────────
		...
		trust: {
			...
			timeline: [
				...
				{ year: '2008', text: 'Incubé chez <strong>inits.at</strong>, l\'incubateur d\'entreprises universitaire de Vienne, avec rigueur académique et soutien institutionnel.' },
				{ year: '2018', text: 'Sélectionné pour l\'accélérateur <strong>weXelerate Batch II</strong> \u00b7 Lancé en open source sous Apache 2.0.' },
			...
			instFFGDesc: 'EDDI a été déployé dans <strong>SecLearn</strong>, une initiative nationale de formation en cybersécurité financée par la FFG, en collaboration avec l\'Austrian Institute of Technology (AIT).',
