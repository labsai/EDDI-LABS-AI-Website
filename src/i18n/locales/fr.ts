...
// ─── New Feature Pages ────────────────────────────────────
		...
		trust: {
			title: 'Bilan',
			description: 'EDDI est soutenu par la recherche financée par les gouvernements, déployé en production d\'entreprise et validé par des institutions académiques européennes — avec les certifications OpenSSF, Codacy et Red Hat.',
			heroTitle: 'Qualité entreprise.',
			heroHighlight: 'Éprouvé par la communauté.',
			heroDesc: 'EDDI n\'est pas un projet de week-end. Il est soutenu par la <strong>recherche financée par les gouvernements</strong>, déployé en <strong>production d\'entreprise</strong> et validé par des <strong>institutions académiques européennes</strong>.',
			statPulls: 'Docker Pulls',
			statTests: 'Tests \u00b7 0 Échecs',
			statProviders: 'Fournisseurs LLM',
			statCertified: 'Certifié Red Hat',
			timelineTitle: 'De Vienne au monde',
			timelineDesc: 'Près de deux décennies de développement continu — bien avant l\'ère des LLM.',
			timeline: [
				{ year: '2006', text: '<strong>Fondation du projet</strong> à Vienne, Autriche — recherche précoce sur la gestion du dialogue et l\'état conversationnel.' },
				...
				{ year: '2018', text: 'Premier <strong>EDDI Chatbot Hackathon</strong> chez weXelerate, Vienne — sponsorisé par weXelerate et T-Mobile.' },
			...
			instFFGTitle: 'Agence autrichienne de promotion de la recherche (FFG)',
			...
			instInitsTitle: 'Incubateur inits.at',
