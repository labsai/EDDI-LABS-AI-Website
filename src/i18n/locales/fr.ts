...
// ─── New Feature Pages ────────────────────────────────────
		...
		trust: {
			...
			timeline: [
				...
				{ year: '2008', text: 'Incubé dans un <strong>incubateur d\'entreprises universitaire</strong> avec encadrement académique, axé sur l\'ingénierie de niveau recherche et le développement de produit durable.' },
				{ year: '2018', text: 'Sélectionné pour un <strong>programme d\'accélération européen de premier plan</strong> \u00b7 Lancé en open source sous Apache 2.0.' },
			...
			instFFGTitle: 'Subvention de recherche gouvernementale',
			instFFGDesc: 'EDDI a été déployé dans <strong>SecLearn</strong>, une initiative nationale de formation en cybersécurité financée par une agence de recherche gouvernementale, en collaboration avec un institut de recherche technologique national.',
			...
			instInitsTitle: 'Incubateur universitaire',
