...
const th: TranslationSchema = {
	...
	nav: {
		...
		codeQualityDesc: '5,100+ เทสต์ ไม่มีข้อผิดพลาด',
		aiReady: 'AI-Ready',
	...
	footer: {
		...
		tests: '5,100+ เทสต์ · ไม่มีข้อผิดพลาด',
	...
	home: {
		...
		trustTests: '5,100+ เทสต์ · 0 ข้อผิดพลาด',
	...
	featuresOverview: {
		...
		cqCardDesc: '<strong>5,100+ เทสต์ ไม่มีข้อผิดพลาด</strong> Checkstyle ศูนย์คำเตือน',
	...
	pages: {
		...
		codeQuality: {
			title: 'คุณภาพโค้ด',
			description: '5,100+ เทสต์ไม่มีข้อผิดพลาด',
			...
			items: [
				'<strong>5,100+ เทสต์</strong> — unit, integration, E2E',
