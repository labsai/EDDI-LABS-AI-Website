...
const th: TranslationSchema = {
	...
	nav: {
		...
		codeQualityDesc: '9,600+ เทสต์ ไม่มีข้อผิดพลาด, >90% coverage',
		aiReady: 'AI-Ready',
	...
	footer: {
		...
		tests: '9,600+ เทสต์ · ไม่มีข้อผิดพลาด',
	...
	home: {
		...
		heroTagline:
			`แพลตฟอร์มโอเพนซอร์สพร้อมใช้งานจริงสำหรับการปรับใช้ระบบ AI หลายเอเจนต์ที่มีธรรมาภิบาล คอนฟิกูเรชันไดรเวน โฮสต์เอง และพร้อมปฏิบัติตามข้อกำหนด — พร้อม UI จัดการแบบวิชวล เครื่องมือ MCP 65 ตัว และความปลอดภัยระดับองค์กรในตัว ขณะนี้ใน <strong>${EDDI_VERSION}</strong> (latest: ${EDDI_LATEST_VERSION})`,
		problemTitle: 'ปัญหา',
		...
		trustTests: '9,600+ เทสต์ · 0 ข้อผิดพลาด',
		...
		unidoCalloutDesc: 'LABS.AI ได้รับเลือกโดยองค์การพัฒนาอุตสาหกรรมแห่งสหประชาชาติ (UNIDO) เป็นพันธมิตรที่ไว้วางใจสำหรับ AI อุตสาหกรรมเพื่อกลุ่มประเทศกำลังพัฒนา — EDDI ได้รับการแนะนำที่ WAIC 2026 (เซี่ยงไฮ้)',
	...
	featuresOverview: {
		...
		cqCardDesc: '<strong>9,600+ เทสต์ ไม่มีข้อผิดพลาด</strong> Checkstyle ศูนย์คำเตือน >90% coverage',
	...
	pages: {
		...
		codeQuality: {
			title: 'คุณภาพโค้ด',
			description: '9,600+ เทสต์ไม่มีข้อผิดพลาด >90% coverage',
			...
			items: [
				'<strong>9,600+ เทสต์</strong> — unit, integration, E2E',
...
// ─── New Feature Pages ────────────────────────────────────
		...
		trust: {
			...
			timelineDesc: 'เกือบสองทศวรรษของวิศวกรรมอย่างต่อเนื่อง — นานก่อนยุค LLM',
			timeline: [
				...
				{ year: '2026', text: 'ได้รับเลือกเป็น<strong>พันธมิตรที่ไว้วางใจ UNIDO</strong> สำหรับ AI อุตสาหกรรมเพื่อกลุ่มประเทศกำลังพัฒนา แนะนำโซลูชันที่ WAIC 2026 (เซี่ยงไฮ้)' },
			],
			...
			instUnidoDesc: 'ได้รับเลือกโดย<strong>องค์การพัฒนาอุตสาหกรรมแห่งสหประชาชาติ</strong> (UNIDO) เป็นพันธมิตรที่ไว้วางใจภายใต้ Global Call สำหรับ AI อุตสาหกรรมเพื่อกลุ่มประเทศกำลังพัฒนา แนะนำที่ WAIC 2026 (เซี่ยงไฮ้)',
			...
			devDockerDesc: 'ตัวชี้วัดการนำคอนเทนเนอร์ไปใช้',
			devCI: 'CI ผ่าน',
		...
		unido: {
			...
			description: 'LABS.AI ได้รับเลือกโดย UNIDO เป็นพันธมิตรที่ไว้วางใจสำหรับ AI อุตสาหกรรมเพื่อกลุ่มประเทศกำลังพัฒนา การจัดการ AI Agent ระดับองค์กรโดยใช้ EDDI — แนะนำที่ WAIC 2026 (เซี่ยงไฮ้)',

			// Hero
			heroBadge: 'มิถุนายน 2026 · WAIC เซี่ยงไฮ้',
			...
			whatCard1Title: 'การรับรองจากสถาบัน UN',
			whatCard1Desc: 'UNIDO เป็นองค์การชำนาญพิเศษของสหประชาชาติที่มี 172 ประเทศสมาชิก อุทิศให้กับการส่งเสริมการพัฒนาอุตสาหกรรมเพื่อลดความยากจน โลกาภิวัตน์ที่ครอบคลุม และความยั่งยืนด้านสิ่งแวดล้อม',
			...
			orgsTitle: 'องค์กร',
			org1Title: 'UNIDO',
			org1Desc: '<strong>องค์การพัฒนาอุตสาหกรรมแห่งสหประชาชาติ</strong> (UNIDO) เป็นองค์การชำนาญพิเศษของ UN ที่ส่งเสริมการพัฒนาอุตสาหกรรมแบบครอบคลุมและยั่งยืน มี 172 ประเทศสมาชิก UNIDO เชื่อมต่อระหว่างประเทศกำลังพัฒนาและประเทศอุตสาหกรรม',
			...
			ctaDesc: 'แพลตฟอร์มเดียวกันที่สหประชาชาติยอมรับพร้อมใช้งานสำหรับองค์กรของคุณ — โอเพนซอร์ส, self-hosted, พร้อมใช้งานจริง',
			ctaGetStarted: 'เริ่มต้นใน 5 นาที',
