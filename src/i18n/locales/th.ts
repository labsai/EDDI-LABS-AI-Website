...
const th: TranslationSchema = {
	...
	nav: {
		...
		mcpServerDesc: '42 เครื่องมือควบคุม AI-Native',
		...
		codeQualityDesc: '9,000+ เทสต์ ไม่มีข้อผิดพลาด, >90% coverage',
		aiReady: 'AI-Ready',
		...
		mcpServerMobile: 'MCP Server (42 เครื่องมือ)',
		resources: 'ทรัพยากร',
	...
	home: {
		...
		faq4A:
			'Model Context Protocol (MCP) เป็น open standard ที่ให้ AI assistants เช่น Claude Desktop, IDE plugins โต้ตอบกับ external tools ด้วยโปรแกรม EDDI เปิดเผย 42 MCP tools ครอบคลุมการจัดการสนทนา, จัดการเอเจนต์, setup automation, schedule management และ diagnostics',
	...
	gettingStarted: {
		...
		step2After: 'ตอนนี้คุณสามารถโต้ตอบกับ 42 MCP tools ของ EDDI ได้โดยตรงจาก AI assistant',
		...
		nextMcpServerDesc: 'ดู MCP tools ทั้ง 42 เครื่องมือ',
		nextDocs: 'เอกสาร ↗',
	...
	featuresOverview: {
		...
		description:
			'ทุกความสามารถที่ทำให้ EDDI เป็น Enterprise AI Orchestrator — EDDI Manager UI, Config-as-Code, 42 MCP Tools, Security-First Architecture และอื่นๆ',
		...
		mcpCardTitle: '🔌 MCP Server (42 เครื่องมือ)',
		...
		cqCardDesc: '<strong>9,000+ เทสต์ ไม่มีข้อผิดพลาด</strong> Checkstyle ศูนย์คำเตือน >90% coverage',
		aiCardTitle: '🧩 AI-Ready',
		aiCardDesc: '42 MCP tools, CRUD patterns ที่คาดเดาได้ <strong>สร้างสำหรับ coding agents</strong>',
	},
	pages: {
		manager: {
			title: 'EDDI Manager',
		...
		mcpServer: {
			title: 'MCP Server — 42 เครื่องมือ',
			description: 'EDDI เปิดเผยความสามารถทั้งหมดผ่าน Model Context Protocol',
			heading1: 'AI-Native Control Plane',
			para1: 'EDDI ใช้ MCP server สมบูรณ์พร้อม <strong>42 เครื่องมือ</strong> ครอบคลุมทุกด้านของแพลตฟอร์ม',
		...
		codeQuality: {
			title: 'คุณภาพโค้ด',
			description: '9,000+ เทสต์ไม่มีข้อผิดพลาด >90% coverage',
		...
		aiReady: {
			...
			items: [
				...
				'<strong>MCP-First</strong> — 42 เครื่องมือสำหรับ AI assistant integration',
...
// ─── New Feature Pages ────────────────────────────────────
		...
		whyEddi: {
			...
			items: [
				...
				'<strong>42 MCP Tools</strong> — AI-native control สมบูรณ์',
		...
		trust: {
			...
			timeline: [
				...
				{ year: '2026', text: '<strong>v6</strong> — 42 เครื่องมือ MCP, โปรโตคอล A2A, การสนทนากลุ่ม, UI การจัดการแบบภาพ, model cascading' },
