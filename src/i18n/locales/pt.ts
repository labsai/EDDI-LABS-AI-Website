...
const pt: TranslationSchema = {
	...
	common: {
		...
		bannerBadge: 'Novo',
		bannerText: `EDDI ${EDDI_VERSION} já está disponível como Developer Preview!`,
		bannerLink: 'Começar',
...
// ─── New Feature Pages ────────────────────────────────────
		...
		trust: {
			...
			timeline: [
				...
				{ year: '2026', text: '<strong>v6.0.0</strong> — 42 ferramentas MCP, protocolo A2A, discussões em grupo, UI de gestão visual, cascading de modelos.' },
			],
