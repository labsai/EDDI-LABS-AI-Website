...
// ─── New Feature Pages ────────────────────────────────────
		...
		trust: {
			title: 'Histórico',
			description: 'EDDI é apoiado por pesquisa financiada pelo governo, implantado em produção empresarial e validado por instituições acadêmicas europeias — com certificações OpenSSF, Codacy e Red Hat.',
			heroTitle: 'Qualidade empresarial.',
			heroHighlight: 'Comprovado pela comunidade.',
			heroDesc: 'EDDI não é um projeto de fim de semana. É apoiado por <strong>pesquisa financiada pelo governo</strong>, implantado em <strong>produção empresarial</strong> e validado por <strong>instituições acadêmicas europeias</strong>.',
			statPulls: 'Docker Pulls',
			statTests: 'Testes \u00b7 0 Falhas',
			statProviders: 'Provedores LLM',
			statCertified: 'Certificado Red Hat',
			timelineTitle: 'De Viena para o mundo',
			timelineDesc: 'Quase duas décadas de engenharia contínua — muito antes da era LLM.',
			timeline: [
				{ year: '2006', text: '<strong>Projeto fundado</strong> em Viena, Áustria — pesquisa inicial em gestão de diálogos e estado conversacional.' },
				{ year: '2008', text: 'Incubado no <strong>inits.at</strong>, o incubador empresarial universitário de Viena, com rigor acadêmico e apoio institucional.' },
				{ year: '2018', text: 'Selecionado para o acelerador <strong>weXelerate Batch II</strong> \u00b7 Lançado como código aberto sob Apache 2.0.' },
				{ year: '2018', text: 'Primeiro <strong>EDDI Chatbot Hackathon</strong> no weXelerate, Viena — patrocinado por weXelerate e T-Mobile.' },
			...
			instFFGTitle: 'Agência Austríaca de Promoção da Pesquisa (FFG)',
			instFFGDesc: 'EDDI foi implantado no <strong>SecLearn</strong>, uma iniciativa nacional de treinamento em cibersegurança financiada pela FFG, em colaboração com o Austrian Institute of Technology (AIT).',
			...
			instWexDesc: 'Selecionado para o <strong>Batch II</strong> do principal hub de inovação da Europa Central, conectando LABS.AI com parceiros empresariais e validando a viabilidade comercial da plataforma.',
			instInitsTitle: 'Incubadora inits.at',
			instInitsDesc: 'Incubado no incubador empresarial universitário de Viena, com apoio institucional em fase inicial priorizando rigor acadêmico e modelagem empresarial sustentável.',
