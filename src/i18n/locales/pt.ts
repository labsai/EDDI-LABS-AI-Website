...
// ─── New Feature Pages ────────────────────────────────────
		...
		trust: {
			...
			timeline: [
				{ year: '2006', text: '<strong>Projeto fundado</strong> na Europa — pesquisa inicial em gestão de diálogos e estado conversacional.' },
				{ year: '2008', text: 'Incubado em um <strong>incubador empresarial universitário</strong> com supervisão acadêmica, focado em engenharia de nível pesquisa e desenvolvimento de produto sustentável.' },
				{ year: '2018', text: 'Selecionado para um <strong>programa de aceleração europeu de primeiro nível</strong> \u00b7 Lançado como código aberto sob Apache 2.0.' },
				{ year: '2018', text: 'Primeiro <strong>EDDI Chatbot Hackathon</strong> — co-patrocinado por um acelerador e um grande provedor de telecomunicações.' },
			...
			instFFGTitle: 'Subvenção de pesquisa governamental',
			instFFGDesc: 'EDDI foi implantado no <strong>SecLearn</strong>, uma iniciativa nacional de treinamento em cibersegurança financiada por uma agência governamental de pesquisa, em colaboração com um instituto nacional de pesquisa tecnológica.',
			...
			instWexDesc: 'Selecionado para o <strong>Batch II</strong> de um <strong>acelerador de inovação europeu líder</strong>, conectando LABS.AI com parceiros empresariais e validando a viabilidade comercial da plataforma.',
			instInitsTitle: 'Incubadora universitaria',
			instInitsDesc: 'Incubado em um <strong>incubador empresarial universitário</strong>, com apoio institucional em fase inicial priorizando rigor acadêmico e modelagem empresarial sustentável.',
