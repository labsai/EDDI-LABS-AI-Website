...
const pt: TranslationSchema = {
	...
	nav: {
		...
		codeQualityDesc: '9.600+ testes, zero falhas, >90% de cobertura',
	...
	common: {
		...
		bannerBadge: '🏆 Reconhecimento ONU',
	...
	footer: {
		...
		tests: '9.600+ Testes · Zero Falhas',
	...
	home: {
		...
		heroTagline:
			`A plataforma de código aberto pronta para produção para implantar sistemas de IA multi-agente governados. Baseada em configuração, auto-hospedada e pronta para conformidade — com UI de gestão visual, 65 ferramentas MCP e segurança empresarial integrada. Agora em <strong>${EDDI_VERSION}</strong> (latest: ${EDDI_LATEST_VERSION}).`,
		...
		trustTests: '9.600+ Testes · 0 Falhas',
		...
		unidoBadge: 'Reconhecimento das Nações Unidas',
		unidoCalloutTitle: 'Parceira de Confiança da UNIDO para IA Industrial',
		unidoCalloutDesc: 'LABS.AI foi selecionada pela Organização das Nações Unidas para o Desenvolvimento Industrial (UNIDO) como Parceira de Confiança para IA Industrial para o Sul Global — com EDDI apresentado no WAIC 2026 em Shanghai.',
		...
		faq6A: 'Não. O EDDI (pela <a href="https://labs.ai" target="_blank" rel="noopener">LABS.AI</a>) é uma plataforma de <strong>orquestração de agentes de IA empresarial</strong> auto-hospedada, construída em Java/Quarkus. Não tem relação com ferramentas de edição de vídeo, softwares de RH, criadores de chatbots ou outros produtos com nomes semelhantes.',
		faq7Q: 'Como o EDDI se compara a plataformas de IA na nuvem, como AWS Bedrock ou Azure AI Studio?',
		faq7A: 'Plataformas de IA na nuvem oferecem infraestrutura gerenciada, mas criam <strong>dependência de fornecedor</strong>. O EDDI funciona onde quer que o Docker funcione. Veja nossa <a href="/enterprise/vs-alternatives/">comparação detalhada</a>.',
	...
	featuresOverview: {
		...
		cqCardDesc: '<strong>9.600+ testes com zero falhas.</strong> Zero avisos de Checkstyle. >90% de cobertura de código. CI/CD aplicado em cada merge.',
	...
	pages: {
		...
		security: {
			...
			crisisPara: 'O ecossistema de agentes de IA está sob uma pressão de segurança sem precedentes.',
			...
			govPara: 'Os recursos de segurança alimentam diretamente a estrutura de conformidade do EDDI. A trilha de auditoria imutável satisfaz os requisitos do EU AI Act (Art. 12-14).',
		...
		performance: {
			...
			benchPara: 'Nenhum runtime vence em todos os cenários. Java supera consistentemente o Node.js em 30 a 68% em cenários envolvendo tarefas intensivas em CPU — exatamente o que os agentes de IA requerem.',
			benchPara2: 'A arquitetura do EDDI é intencionalmente otimizada para cargas de trabalho mistas I/O + CPU: Quarkus com threads virtuais, combinado com pools de conexão compatíveis com Loom (Agroal).',
		...
		codeQuality: {
			...
			description:
				'9.600+ testes com zero falhas. Zero avisos de Checkstyle. >90% de cobertura de código. Portas de qualidade CI/CD aplicadas em cada merge.',
			...
			items: [
				'<strong>9.600+ Testes</strong> — Cobertura unitária, de integração e ponta a ponta',
		...
		whyEddi: {
			...
			rfpItems: [
				...
				{ category: 'Privacidade de dados', question: 'Como os direitos dos titulares de dados são implementados?', eddiAnswer: 'API REST unificada em cascata em todos os 5 armaéns de dados. 15+ frameworks regulatórios.' },
			...
			tcoDeployItems: [
				...
				'Mantido por um projeto open-source de 18 anos',
			],
			roiTitle: 'O caso de negócio',
			roiPara: 'O valor do EDDI é medido no <strong>que as equipes não precisam construir</strong>.',
			roiPara2: 'Para setores regulamentados, a equação de custo é ainda mais clara: a alternativa ao EDDI é uma implementação de conformidade personalizada que abrange mais de 15 estruturas regulatórias.',
		...
		trust: {
			...
			timeline: [
				...
				{ year: '2026', text: 'Selecionado como <strong>Parceiro de Confiança da UNIDO</strong> para IA Industrial para o Sul Global. Solução apresentada no WAIC 2026 · Shanghai.' },
			],
			...
			instUnidoDesc: 'Selecionado pela <strong>Organização das Nações Unidas para o Desenvolvimento Industrial</strong> (UNIDO) como Parceiro de Confiança no âmbito da Chamada Global para IA Industrial para o Sul Global. Apresentado no WAIC 2026 · Shanghai.',
		...
		unido: {
			...
			description: 'LABS.AI foi selecionada pela UNIDO como Parceira de Confiança para IA Industrial para o Sul Global. Orquestração de Agentes de IA Empresarial com EDDI — apresentado no WAIC 2026 em Shanghai.',

			// Hero
			heroBadge: 'Junho 2026 · WAIC Shanghai',
			...
			solutionDesc: 'O EDDI fornece uma plataforma auto-hospedada e orientada por configuração para implantar sistemas de IA multi-agente governados — projetada especificamente para a digitalização industrial. A plataforma foi especificamente reconhecida pela sua capacidade de servir organizações no Sul Global:',
			...
			whatCard1Title: 'Validação Institucional da ONU',
			whatCard1Desc: 'A UNIDO é uma agência especializada das Nações Unidas com 172 estados membros, dedicada a promover o desenvolvimento industrial para a redução da pobreza, a globalização inclusiva e a sustentabilidade ambiental.',
			...
			org1Title: 'UNIDO',
			org1Desc: 'A <strong>Organização das Nações Unidas para o Desenvolvimento Industrial</strong> (UNIDO) é uma agência especializada da ONU que promove o desenvolvimento industrial inclusivo e sustentável. Com 172 estados membros, a UNIDO serve de ponte entre nações em desenvolvimento e industrializadas.',
			...
			ctaDesc: 'A mesma plataforma reconhecida pelas Nações Unidas está disponível para a sua organização — código aberto, auto-hospedada e pronta para produção.',
			ctaGetStarted: 'Comece em 5 Minutos',
