...
const ar: TranslationSchema = {
	meta: {
		siteTitle: 'EDDI',
		siteDescription:
			`EDDI ${EDDI_VERSION}، منصة تنسيق وكلاء الذكاء الاصطناعي للمؤسسات. نظام متعدد الوكلاء مستضاف ذاتياً وقائم على التكوين، مع واجهة إدارة مرئية و84 أداة MCP وبنية الأمان أولاً وامتثال تنظيمي مدمج لـ GDPR وقانون الذكاء الاصطناعي الأوروبي وHIPAA وأكثر من 15 إطاراً تنظيمياً.`,
	},
	nav: {
		features: 'الميزات',
		docs: 'التوثيق',
		...
		mcpServer: 'خادم MCP',
		mcpServerDesc: '84 أداة للتحكم الأصلي بالذكاء الاصطناعي',
		...
		multiAgentDesc: 'تعاون جماعي وتوجيه بالنوايا',
		...
		humanInTheLoop: `مشاركة بشرية في الحلقة`,
		humanInTheLoopDesc: `بوابات موافقة، مهلات، اعتماد عبر Slack`,
		...
		trackRecord: 'السجل الحافل',
		trackRecordDesc: 'الدعم المؤسسي والنشر الفعلي',
		useCases: 'حالات الاستخدام',
		useCasesDesc: 'أنماط نشر للصناعات المنظمة',
		allFeatures: 'جميع الميزات',
		mcpServerMobile: 'خادم MCP (84 أداة)',
		resources: 'الموارد',
	...
	common: {
		...
		// Enterprise CTA
		enterpriseCtaTitle: 'هل أنت جاهز للإنتاج؟',
		enterpriseCtaDesc: 'احصل على نشر مُدار ودعم مدعوم باتفاقيات مستوى الخدمة (SLA) ومساعدة عملية من الفريق الذي يبني EDDI.',
		enterpriseCtaBtn: 'تحدث معنا حول النشر المؤسسي',
	},
	footer: {
		...
		euAiAct: 'الامتثال',
		trackRecord: 'السجل الحافل',
		unidoPartner: 'شراكة UNIDO',
		useCases: 'حالات الاستخدام',
		solutionsSite: 'السحابة المُدارة ودعم المؤسسات',
		...
		initiated: 'بدأ في فيينا. طُوّر بـ ❤️ في فيينا (أوروبا). صُنع للعالم.',
	},
	newsletter: {
		...
		consentNotice:
			'يُقدَّم نموذج الاشتراك في النشرة الإخبارية بواسطة HubSpot (الولايات المتحدة). تحميله يضع ملفات تعريف ارتباط وينقل بيانات إلى HubSpot. انقر أدناه لتحميل النموذج والموافقة على هذه المعالجة. راجع <a href="{privacyUrl}">سياسة الخصوصية</a> الخاصة بنا.',
		consentCta: 'إظهار نموذج الاشتراك',
	},
	home: {
		...
		heroTagline:
			`المنصة مفتوحة المصدر لنشر أنظمة ذكاء اصطناعي متعددة الوكلاء ومحكومة: مستضافة ذاتياً، قائمة على التكوين، وجاهزة للامتثال. متوفرة الآن في <strong>${EDDI_VERSION}</strong>.`,
		...
		sol6Desc:
			'اكتشاف الوكلاء القائم على النية، والمحادثات المُدارة، و<strong>التعاون الجماعي</strong>: يتداول الوكلاء بسبعة أنماط، ويصوّتون، ويحررون نواتج العمل المشتركة معاً، ويمنحون البشر مقعداً إلى الطاولة.',
		...
		techLangchainDesc: 'دعم LLM متعدد المزودين',
		techMongo: 'MongoDB',
		...
		faq1Q: 'ما هو EDDI؟',
		faq1A:
			'EDDI هو وسيط تنسيق ذكاء اصطناعي مفتوح المصدر، أصلي على JVM، مبني على Quarkus و Java 25. يمكّن فرق المؤسسات من بناء وتكوين ونشر وكلاء ذكاء اصطناعي باستخدام تكوين JSON بدلاً من الشفرة المجمعة. يوفر EDDI منصة كاملة مع <strong>واجهة إدارة React جاهزة للإنتاج</strong> (مدير EDDI)، وواجهات REST API مدمجة، وإدارة حالة المحادثة، والأمان (OIDC/Keycloak)، ومسارات تدقيق غير قابلة للتغيير، و84 أداة MCP، كل ذلك قابل للنشر عبر Docker أو Kubernetes.',
		faq2Q: 'كيف يختلف EDDI عن مكتبات وأُطر عمل الذكاء الاصطناعي؟',
		faq2A:
			'مكتبات الذكاء الاصطناعي مثل LangChain و Spring AI و LangChain4j تمنحك لبنات البناء، لكنك لا تزال بحاجة لبناء وحدات تحكم REST والمصادقة وإدارة حالة المحادثة وتسجيل التدقيق وواجهات الإدارة بنفسك. EDDI هو <strong>منصة وسيطة قابلة للنشر</strong>، وليس مكتبة. يوفر كل ذلك جاهزاً، قابلاً للنشر عبر Docker.',
		faq3Q: 'هل EDDI جاهز للاستخدام المؤسسي في الإنتاج؟',
		faq3A:
			'نعم. يعمل EDDI على Java 25 مع Quarkus، مستفيداً من Virtual Threads للتزامن الضخم في عمليات الإدخال/الإخراج. يدعم MongoDB و PostgreSQL، يتضمن مصادقة OIDC/Keycloak مدمجة ومساحات عمل لكل مستخدم مع مشاركة الموارد، يوفر مسارات تدقيق مشفرة غير قابلة للتغيير للامتثال (بما في ذلك قانون الذكاء الاصطناعي الأوروبي)، ويتوسع أفقياً عبر NATS JetStream.',
		faq4Q: 'ما هو بروتوكول سياق النموذج (MCP)؟',
		faq4A:
			'بروتوكول سياق النموذج (MCP) هو معيار مفتوح يسمح لمساعدي الذكاء الاصطناعي مثل Claude Desktop وإضافات IDE والعملاء المخصصين بالتفاعل مع الأدوات الخارجية برمجياً. يكشف EDDI 84 أداة MCP تشمل إدارة المحادثات وإدارة الوكلاء والمناقشات الجماعية والموافقات البشرية وأتمتة الإعداد وإدارة الجداول والتشخيصات.',
		...
		demoModalBody: 'هذه نسخة تجريبية حية من EDDI متاحة للجميع للاستكشاف. مخصصة فقط للتقييم والتجربة، يرجى عدم استخدامها لأعباء الإنتاج أو تخزين البيانات الحساسة أو الاعتماد على توفرها.',
		demoModalCancel: 'إلغاء',
		demoModalOpen: 'فتح العرض التجريبي',
	},
	gettingStarted: {
		title: 'البدء',
		...
		step1ComposeOllama: 'تريد نموذجاً محلياً؟ أضف تراكب Ollama، وستبدأ الوكلاء الجديدة بعنوان Ollama الأساسي مُعبّأً مسبقاً:',
		step1After: 'سيكون EDDI متاحاً على <code>http://localhost:7070</code>.',
		step2Title: '2. اتصل عبر MCP',
		step2Desc: 'قم بتوصيل مساعدك الذكي بـ <strong>84 أداة MCP</strong> في EDDI. يعتمد التكوين على دعم النقل لعميلك:',
		...
		step3VaultTip: '<strong>💡 نصيحة:</strong> صيغة <code>${vault:my-anthropic-key}</code> تشير إلى <a href="https://docs.labs.ai/security-and-compliance/secrets-vault" target="_blank" rel="noopener">Secrets Vault</a> المدمج في EDDI. يتم إنشاء المفتاح الرئيسي للخزنة تلقائيًا بواسطة المثبت. للاختبار السريع، يمكنك أيضًا تمرير مفاتيح API مباشرة: <code>apiKey: "sk-ant-..."</code>.',
		step4Title: '4. إنشاء وكيلك الأول',
		step4Desc: 'استخدم <code>setup_agent</code> لإنشاء وكيل كامل الوظائف في مكالمة واحدة، عبر MCP أو REST API:',
		step4After: 'هذا ينشئ القواعد وتكوين LLM وسير العمل والوكيل وينشره، كل ذلك في خطوة واحدة.',
		step4Operator: 'تفضل محادثة أو نموذجاً؟ يبدأ التثبيت الجديد دون أي وكلاء منشورين. افتح <strong>Platform Operator</strong> على <code>http://localhost:7070/manage/operator</code> وصِف الوكيل الذي تريده، مع انتظار كل تغيير لموافقتك، أو املأ معالج الوكلاء على <code>http://localhost:7070/manage/agents/wizard</code>.',
		step5Title: '5. تحدث مع وكيلك',
		step6Title: '6. افتح واجهة الإدارة',
		step6Desc:
			'انتقل إلى <code>http://localhost:7070</code> لإدارة وكلائك وسير العمل والمحادثات بصريًا باستخدام EDDI Manager.',
		...
		nextMcpServerDesc: 'تصفح جميع أدوات MCP الـ 84',
		nextDocs: 'التوثيق ↗',
		...
		// Installer Options
		installerOptionsTitle: 'خيارات التثبيت',
		installerOptionsDesc: 'يدعم سكريبت التثبيت أعلامًا للإعدادات الآلية والمخصصة:',
		installerFlags: [
			'<code>--defaults</code>، جميع الإعدادات الافتراضية، بدون مطالبات',
			'<code>--db=postgres</code>، استخدام PostgreSQL بدلاً من MongoDB',
			'<code>--with-auth</code>، تفعيل مصادقة Keycloak',
			'<code>--with-monitoring</code>، إضافة مراقبة Prometheus وGrafana',
			'<code>--full</code>، كل شيء مفعّل (قاعدة بيانات + مصادقة + مراقبة)',
			`<code>--eddi-version=${EDDI_LATEST_VERSION}</code>، تحديد إصدار معين من EDDI`,
			'<code>--local</code>، بناء صورة Docker من المصدر المحلي (للمساهمين)',
		],
		// Update CLI
		updateTitle: 'تحديث EDDI',
		updateDesc: 'يُنشئ المُثبّت غلاف CLI <code>eddi</code>. لسحب أحدث صورة وإعادة التشغيل:',
		updateFallback: 'إذا لم يكن CLI متاحًا، قم بالتشغيل من دليل التثبيت (<code>~/.eddi</code>):',
		// Kubernetes
	...
	useCases: {
		...
		healthcareDesc:
			'وكلاء استقبال المرضى والأسئلة الشائعة الطبية وجدولة المواعيد مُعرَّفون كتكوين-كشفرة، بحيث تعدّل الفرق السريرية الموجهات والقواعد دون دورة إعادة نشر. كل محادثة تُكتب في مسار التدقيق غير القابل للتغيير والموقّع بـ HMAC، وواجهة GDPR/طلبات صاحب البيانات الموحدة تتعامل مع طلبات المحو والتصدير. النشر الذاتي الاستضافة يبقي البيانات الصحية داخل بنيتك التحتية استعداداً لـ HIPAA وقانون الذكاء الاصطناعي الأوروبي.',
		finance: 'الخدمات المالية',
		financeDesc:
			'وكلاء دعم العملاء، ومساعدو تصنيف الاحتيال، وروبوتات قاعدة المعرفة الداخلية تجمع بين RAG على مستنداتك الخاصة ومسار التدقيق غير القابل للتغيير لتسجيل امتثال قابل للدفاع عنه. تتابع النماذج يوجّه الاستعلامات الروتينية إلى نماذج أرخص ولا يصعّد إلا عند انخفاض الثقة، مما يبقي تكلفة كل محادثة تحت السيطرة. يلبي OIDC/Keycloak وخزنة الأسرار متطلبات التحكم في الوصول المؤسسي.',
		ecommerce: 'التجارة الإلكترونية',
		ecommerceDesc:
			'وكلاء توصية المنتجات ودعم الطلبات والخدمة متعددة اللغات، مدعومون بتوجيه متعدد الوكلاء قائم على النية، بحيث يصل كل طلب إلى الوكيل المتخصص الذي أعلن عن النية المطابقة. تستدعي الوكلاء أدوات الويب وHTTP وRAG المدمجة لجلب بيانات الكتالوج والطلبات الحية، ويتيح توجيه A/B اختبار أنواع مختلفة من الوكلاء على حركة مرور حقيقية قبل اعتماد أحدها.',
		manufacturing: 'التصنيع',
		manufacturingDesc:
			'مساعدو صيانة المعدات ومراقبة الجودة وسلسلة التوريد تعمل بالكامل مستضافة ذاتياً محلياً أو في سحابة خاصة، بدون أي اعتماد على واجهة برمجية أمريكية المنشأ. تتيح مشغلات الجدولة والنبضات للوكلاء إجراء فحوصات دورية وملخصات استباقية بمعدل cron، وتربط أدوات MCP الـ84 مع استيعاب OpenAPI الوكلاء بأنظمة الأعمال القائمة.',
		government: 'الحكومة',
		governmentDesc:
			'وكلاء استفسارات المواطنين، وأتمتة العمليات الداخلية، وتحليل المستندات في بيئات معزولة تماماً، باستخدام نماذج محلية عبر Ollama أو Jlama بحيث لا تغادر أي بيانات الشبكة. التكوين-كشفرة يجعل كل قرار للوكيل قابلاً لإعادة الإنتاج لأغراض التدقيق، ومسار التدقيق غير القابل للتغيير إلى جانب ضوابط الإشراف البشري في واجهة Manager يتطابقان مباشرة مع متطلبات حفظ السجلات والإشراف في قانون الذكاء الاصطناعي الأوروبي.',
		devPlatforms: 'منصات المطورين',
		devPlatformsDesc:
			'خدمات ذكاء اصطناعي داخلية لفرق الهندسة، مطروحة كوكلاء يمكن الوصول إليهم عبر API وMCP وتندمج في خطوط أنابيب CI/CD ومراجعة الشفرة وسير عمل التوثيق. تُنشأ الوكلاء وتُدار برمجياً باستدعاء واحد لـ setup_agent، وواجهات CRUD قابلة للتنبؤ، و84 أداة MCP، بحيث يمكن لوكلاء البرمجة في Claude وCursor وVS Code تشغيل EDDI مباشرة، وتضع واجهة API متوافقة مع OpenAI الوكلاء أنفسهم خلف Open WebUI أو أي عميل OpenAI.',
		ctaTitle: 'هل أنت جاهز لبناء حالة استخدامك؟',
		ctaDesc: 'ثبّت EDDI في خمس دقائق، أنشئ وكيلك الأول، وطبّق أياً من هذه الأنماط على نشرك الخاص. تفضّل التحدث عن الأمر أولاً؟ يسعدنا مساعدتك.',
		ctaButton: 'ابدأ في 5 دقائق',
		ctaSecondary: 'تحدث معنا حول حالة استخدامك',
	},
	featuresOverview: {
		...
		securityCardDesc: 'بدون <code>eval()</code>، تكامل الخزنة، حماية من اجتياز المسار، OIDC/Keycloak، مساحات عمل لكل مستخدم، <strong>مسارات تدقيق مشفرة</strong>.',
		...
		multiCardDesc: 'اكتشاف قائم على النية، محادثات مُدارة، و<strong>تعاون جماعي</strong> مع التصويت والمخرجات المشتركة والبشر كأعضاء.',

		hitlCardTitle: `✋ مشاركة بشرية في الحلقة`,
		hitlCardDesc: `أوقف دورة مؤقتاً، أو اضبط بوابة على استدعاء أداة، أو اشترط اعتماد مرحلة. <strong>تدفقات موافقة</strong> مع سياسات مهلة وبطاقات Slack وحالة تصمد أمام الأعطال.`,
		...
		toolsTitle: 'أدوات الوكيل المدمجة',
		toolsDesc:
			'يأتي EDDI مع <strong>12 أداة جاهزة للاستخدام</strong> يمكن للوكلاء استدعاؤها أثناء المحادثات، بدون إعداد خارجي.',
		tools: [
			{ icon: '🔍', name: 'بحث الويب', desc: 'DuckDuckGo أو Google Custom Search' },
			{ icon: '🧮', name: 'الآلة الحاسبة', desc: 'محلل رياضي معزول (بدون eval())' },
			{ icon: '🌐', name: 'كاشط الويب', desc: 'استخراج محتوى محمي من SSRF' },
			{ icon: '📄', name: 'قارئ PDF', desc: 'استخراج مستندات محمي من SSRF' },
			{ icon: '☁️', name: 'الطقس', desc: 'بيانات طقس فورية' },
			{ icon: '🕐', name: 'التاريخ/الوقت', desc: 'التاريخ والوقت الحاليان' },
			{ icon: '📊', name: 'منسق البيانات', desc: 'تحويل البيانات المهيكلة' },
			{ icon: '📝', name: 'ملخص النصوص', desc: 'تلخيص بواسطة LLM' },
			{ icon: '🔌', name: 'استدعاءات HTTP', desc: 'كشف واجهات REST كأدوات LLM' },
			{ icon: '🧠', name: 'ذاكرة المستخدم', desc: 'قراءة/كتابة/بحث الذاكرة الدائمة' },
			{ icon: '🔙', name: 'استدعاء المحادثة', desc: 'التعمق في السجل الملخص' },
			{ icon: '📎', name: 'متعدد الوسائط', desc: 'صورة، PDF، صوت، فيديو عبر توجيه MIME' },
		],
		// Config & Portability section
		portTitle: 'التكوين والقابلية للنقل',
		portDesc:
	...
	pages: {
		manager: {
			...
			items: [
				...
				'<strong>Platform Operator ومعالج الوكلاء</strong>: صِف وكيلاً في محادثة أو املأ نموذجاً. كل عملية كتابة يقترحها المشغّل تنتظر موافقتك',
		...
		mcpServer: {
			...
			para1:
				'بروتوكول سياق النموذج (MCP) هو معيار مفتوح يسمح لمساعدي الذكاء الاصطناعي بالتفاعل مع الأدوات الخارجية. ينفذ EDDI خادم MCP شامل مع <strong>84 أداة</strong> تغطي كل جانب من جوانب المنصة.',
			...
			items: [
				...
				'<strong>أدوات الإدارة (29)</strong>: نشر وإلغاء نشر وإنشاء وتحديث وحذف الوكلاء والموارد والمشغلات والجداول وتكاملات Slack أو القنوات المخصصة',
				...
				'<strong>أدوات المحادثة الجماعية (18)</strong>: مناقشات متعددة الوكلاء بـ 7 أنماط، قوالب جاهزة، متابعات مع الأعضاء، مجموعات متداخلة، وقوائم مهام الفرق الدائمة',
				'<strong>أدوات المشاركة البشرية (10)</strong>: عرض الموافقات المعلقة وفحصها، استئناف المحادثات الموقوفة أو إلغاؤها، اعتماد مراحل المجموعة، وتقديم دور العضو البشري',
				...
				'<strong>أدوات التوثيق (2)</strong>: قراءة توثيق EDDI نفسه، المتاح أيضاً كموارد MCP وعبر REST',
		...
		configAsCode: {
			...
			items: [
				...
				'<strong>استيراد / تصدير</strong>: الوكلاء قابلون للنقل كملفات ZIP مع تنظيف تلقائي للأسرار عند التصدير. الاستيراد يدمج أو يستبدل، لا تعارضات إصدارات',
			...
			para2:
				'يدير EDDI موارد التكوين التالية: <strong>القواعد</strong> (موجهات النظام)، <strong>سير العمل</strong> (تعريفات خط الأنابيب)، <strong>موصلات LLM</strong> (إعدادات المزود)، <strong>موصلات HTTP</strong> (تكامل API خارجي)، <strong>Connections</strong> (طريقة المصادقة مع نظام خارجي)، <strong>المجموعات</strong> (مناقشات متعددة الوكلاء)، <strong>الوكلاء</strong> (وصفات النشر)، و<strong>البيئات</strong> (أهداف النشر).',
		},
		security: {
			...
			crisisPara: 'يتعرض نظام وكلاء الذكاء الاصطناعي لضغوط أمنية غير مسبوقة. في أوائل 2026، وُثّقت علناً مئات الثغرات الحرجة عبر أُطر عمل الوكلاء الرئيسية مفتوحة المصدر، بما في ذلك ثغرات تنفيذ شفرة عن بُعد بتصنيف CVSS 10.0، وحالات هروب من البيئات المعزولة، وتجاوزات للتفويض. السبب الجذري في معظم الحالات: <strong>منصات تنفذ شفرة مقدمة من المستخدم أو مولدة ديناميكياً في وقت التشغيل</strong>.',
			...
			items: [
				...
				'<strong>OIDC/Keycloak</strong>: مصادقة وتفويض مؤسسي مع أدوار RBAC (admin وeditor وviewer) ودور مخصص للمعتمِدين',
				'<strong>مساحات عمل لكل مستخدم</strong>: لكل مورد تكوين مالك، ومساحة شخصية أو للفريق، ومشاركة صريحة بمستوى الاستخدام أو العرض أو التعديل أو الملكية',
				'<strong>Connections</strong>: نموذج موحد لبيانات الاعتماد للاستدعاءات الخارجية، من المفاتيح على مستوى المؤسسة وحسابات خدمة OAuth2 إلى حساب OAuth الخاص بكل مستخدم أو بيانات اعتماد يقدمها النظام المستدعي مع كل طلب. الأسرار دائماً مراجع للخزنة',
				'<strong>حواجز نتائج الأدوات</strong>: تحمل كل نتيجة أداة مصدرها، ويُعلَّم النص ذو الطابع التوجيهي داخلها أو يُنقَّح أو يُحذَّر منه أو يُحظر قبل أن يتصرف النموذج بناءً عليه',
				...
				'<strong>حماية SSRF</strong>: التحقق من URL وقوائم النطاقات المسموح بها تمنع تزوير الطلبات من جانب الخادم، وتُرفض نقاط نهاية البيانات الوصفية السحابية كأهداف لاستدعاءات HTTP وMCP وA2A، بما في ذلك عبر تحليل DNS وإعادة التوجيه',
				...
				'<strong>تنقيح الأسرار</strong>: فلتر آلي يزيل مفاتيح API ومراجع الخزنة والبيانات الحساسة من جميع إدخالات التدقيق',
		...
		performance: {
			...
			items: [
				...
				'<strong>بيئة تشغيل Quarkus</strong>: Java سحابي أصلي مع إعادة تحميل ساخن في وضع التطوير، محسّن للحاويات. يقدم Quarkus إنتاجية أعلى بكثير وبدء تشغيل أسرع من حزم JVM التقليدية، مع بصمة ذاكرة أصغر',
				'<strong>تجمعات اتصال متوافقة مع Loom</strong>: تجمع اتصالات Agroal يتجنب اختناقات ThreadLocal التي يمكن أن تؤثر على تجمعات الاتصال التقليدية تحت أحمال الخيوط الافتراضية',
				...
				'<strong>بث SSE</strong>: استجابات محادثة فورية وتغذية مناقشات جماعية وبث سجلات مباشر عبر Server-Sent Events، مع إخراج رمزاً برمز حتى أثناء تشغيل الأدوات',
				'<strong>تثبيت بأمر واحد</strong>: معالج تفاعلي ينشر EDDI + قاعدة البيانات عبر Docker Compose ويولّد مفتاح الخزنة',
				'<strong>معتمد من Red Hat</strong>: صورة UBI 10 منشورة في كتالوج Red Hat المعتمد، مع فحوصات تمهيدية آلية في CI/CD',
			],
			benchTitle: 'الأداء في السياق',
			benchPara: 'لا توجد بيئة تشغيل تفوز في كل سيناريو. يمكن لـ Node.js أن يتفوق على Java في سيناريوهات توجيه محددة جداً قائمة على الإدخال/الإخراج الخالص، بينما يتصدر Java باستمرار في أحمال العمل التي تتضمن مهام كثيفة المعالجة، وهو بالضبط ما يتطلبه وكلاء الذكاء الاصطناعي. ينفذ الوكلاء الحديثون مزيجاً معقداً من <strong>إدخال/إخراج ضخم</strong> (استدعاءات LLM API، استعلامات المتجهات) و<strong>حوسبة مكثفة</strong> (تحويل البيانات، منطق التوجيه، معالجة التضمينات، تقييم الثقة). ملف أحمال العمل المختلطة هذا هو بالضبط حيث تقدم الخيوط الافتراضية على Quarkus أقوى ميزاتها.',
			benchPara2: 'بنية EDDI محسّنة عمداً لهذا الواقع: Quarkus مع الخيوط الافتراضية لطبقة تنسيق الوكلاء كثيفة الإدخال/الإخراج، مع تجمعات اتصال متوافقة مع Loom (Agroal) تتجنب مشاكل تنافس ThreadLocal التي تُلاحظ مع مكتبات التجميع التقليدية تحت تزامن عالٍ للخيوط الافتراضية.',

		},
		multiAgent: {
			title: 'تنسيق متعدد الوكلاء',
			description:
				'اكتشاف الوكلاء القائم على النية، محادثات مُدارة، وتعاون جماعي: يتداول الوكلاء ويصوّتون ويتشاركون نواتج العمل ويعملون جنباً إلى جنب مع البشر.',
			...
			items2: [
				...
				'<strong>التصويت</strong>: تجمع مراحل التصويت أصواتاً صريحة (بالأغلبية أو بالموافقة، مرجّحة، مشروطة بالنصاب) وتسجل القرار مع الحصيلة الكاملة ورأي الجانب الخاسر المعارض',
				'<strong>المخرجات المشتركة والمزايدة على المهام</strong>: يحرر الأعضاء معاً ناتج عمل مشتركاً مُتحقَّقاً منه ويقدمون عروضاً على المهام بدلاً من إسنادها بالتناوب',
				'<strong>البشر كأعضاء</strong>: يشارك شخص بدور حقيقي في النقاش، وليس مجرد موافقة',
				...
				'<strong>قوالب جاهزة</strong>: فريق بحث، فريق تحرير، فريق عمليات، مجلس قرار، وطاولة تفاوض، جاهزة للإنشاء',
				...
				'<strong>تكامل Slack</strong>: نشر الوكلاء في قنوات Slack وتشغيل مناظرات متعددة الوكلاء مباشرة في المواضيع، مع دعم الرسائل المباشرة والتوجيه بالكلمات المفتاحية، ووضع مراقبة يتابع فيه الوكيل قناة ولا يرد إلا عند تطابق كلمة مفتاحية أو نوع ملف، ضمن حدود فترة التهدئة وعدد الردود اليومية والتكلفة اليومية',
				'<strong>Platform Operator</strong>: وكيل وصفي يقرأ نشرتك ويشغّلها (بما في ذلك إنشاء وكلاء آخرين)، مع خضوع كل عملية كتابة لموافقة بشرية',
		...
		observability: {
			...
			items: [
				...
				'<strong>لوحات Grafana</strong>: لوحة عمليات مُعدة مسبقاً، إضافة إلى لوحة Full Metrics Reference تضم لوحة لكل مقياس مسجَّل',
		...
		aiReady: {
			...
			description: '84 أداة MCP، أنماط CRUD قابلة للتنبؤ، واجهات API ذاتية التوثيق. مصمم من الألف إلى الياء لوكلاء البرمجة.',
			...
			items: [
				...
				'<strong>MCP أولاً</strong>: 84 أداة مصممة للتكامل مع مساعدي الذكاء الاصطناعي',
				'<strong>أتمتة الإعداد</strong>: إنشاء وكلاء في استدعاء واحد مع <code>setup_agent</code>',
				'<strong>واجهة API متوافقة مع OpenAI</strong>: تظهر الوكلاء المنشورة كنماذج لـ Open WebUI و SDK <code>openai</code> و LangChain و LiteLLM',
				'<strong>توثيق للوكلاء</strong>: توثيق EDDI قابل للقراءة عبر MCP و REST، بحيث يستطيع الوكيل الاطلاع على طريقة عمل المنصة قبل أن يتصرف',
			],
		},
		memory: {
			...
			items: [
				...
				'<strong>سياسة الذاكرة (أعلام الالتزام)</strong>: انضباط كتابة صارم يعلّم مخرجات المهام الفاشلة كغير ملتزمة (مخفية عن سياق LLM) ويحقن ملخصات أخطاء موجزة للتدهور السلس',
			],
		...
		humanInTheLoop: {
			...
			description: `أوقف دورة مؤقتاً، أو اضبط بوابة على استدعاء أداة بعينه، أو اشترط اعتماداً بشرياً على مرحلة نقاش. تدفقات موافقة مع سياسات مهلة وبطاقات Slack وحالة تصمد أمام إعادة التشغيل، أُطلقت في EDDI 6.2.0.`,
			heading1: `استقلالية مع زر إيقاف`,
			para1: `تبقى الوكلاء المستقلة مفيدة حتى اللحظة التي تنفذ فيها إجراءً لا يمكن التراجع عنه. قدّم EDDI 6.2.0 <strong>الحوكمة بمشاركة بشرية</strong>: بوابات موافقة صريحة على ثلاثة مستويات من التفصيل، تسندها سياسات المهلة وكشف الحلقات وحالة تبقى بعد إعادة التشغيل. الموافقات تكوين، وليست شفرة تطبيق مخصصة.`,
			whyTitle: `لماذا يجب أن تكون بوابات الموافقة داخل المنصة`,
			whyPara: `تضيف معظم الفرق الموافقات على طبقة التطبيق: طابور هنا، وويب هوك هناك، وعلامة في قاعدة البيانات في مكان ثالث. ينهار هذا النهج فور إعادة تشغيل العملية، أو خروج المعتمِد عن الاتصال، أو إعادة الوكيل الطلب نفسه في حلقة. يضع EDDI البوابة داخل خط أنابيب المحادثة نفسه: تبقى الدورة الموقوفة موقوفة، ويُرفض أي إدخال يسبق القرار برسالة <code>409 Conflict</code> واضحة، ويُسجَّل كل قرار في مسار التدقيق نفسه الذي يوثق بقية دورة حياة الوكيل.`,
			heading2: `ثلاثة مستويات للموافقة`,
			items: [
				`<strong>الموافقة على مستوى الدورة</strong>: يوقف إجراء <code>PAUSE_CONVERSATION</code> خط الأنابيب بالكامل. وإلى أن يستأنفه إنسان، تعيد أي مدخلات إضافية من المستخدم <code>409 Conflict</code>، فلا يسبق شيء القرار المعلق.`,
			...
			timeoutItems: [
				`<code>WAIT_INDEFINITELY</code>: يبقى التشغيل موقوفاً حتى يقرر إنسان. للإجراءات التي لا يجوز تنفيذها دون إشراف أبداً.`,
				`<code>AUTO_APPROVE</code>: يستمر التنفيذ بعد انتهاء المهلة. مناسب للإجراءات منخفضة المخاطر حيث تكون الرقابة فحصاً بالعينة لا بوابة صارمة.`,
				`<code>AUTO_REJECT</code>: يُرفض الإجراء المعلق ويتابع الوكيل مساره الخاص بالرفض.`,
				`<code>ABORT</code>: يُنهى التشغيل فوراً، وهو الخيار الأكثر أماناً للعمليات غير القابلة للتراجع أو واسعة الأثر.`,
			],
			opsTitle: `مبني ليصمد في الإنتاج`,
			opsPara: `يُحكم على نظام الموافقات في أسوأ أيامه: إعادة تشغيل في منتصف المراجعة، ووكيل يكرر السؤال نفسه، ومعتمِد يعيش في Slack لا في واجهة الإدارة.`,
			opsItems: [
				`<strong>حارس انعدام التقدم</strong>: ينشئ EDDI بصمة لكل توقف. وحين تتكرر البصمات نفسها بعد قرارات آلية، يتعرف على حلقة موافقة لا نهائية ويكسرها بدل إهدار الرموز عليها.`,
				`<strong>التعافي من الأعطال</strong>: تبقى الموافقات المعلقة بعد إعادة تشغيل الخادم، ويُعاد ضبط مؤقتات المهلة تلقائياً، فلا يفقد النشر التدريجي قراراً جارياً في صمت.`,
				`<strong>الموافقات عبر Slack</strong>: تنقل بطاقات Block Kit التفاعلية القرار إلى المعتمِد، مع معاينات وسائط محجوبة وقوائم معتمِدين مصرح لهم، بحيث لا يتصرف على البطاقة سوى المخولين.`,
				`<strong>الموافقات عبر MCP</strong>: يمكن للعملاء الخارجيين عرض الموافقات المعلقة وقبولها أو رفضها عبر أدوات MCP، وهي جزء من الأدوات الـ84، مما يحول بيئة التطوير أو عميل الوكيل إلى مستوى تحكم.`,
				`<strong>اعتمد ما سيُنفَّذ فعلاً</strong>: ترتبط الموافقة بالطلب بعد حله، ويرى معتمدو استدعاءات MCP وA2A الهدف وبصمة الطلب، وليس اسم الأداة فقط.`,
				`<strong>Platform Operator خاضع للبوابة</strong>: يستطيع Platform Operator إنشاء الوكلاء وتغييرها عبر API الخاص بـ EDDI، وتنتظر كل عملية كتابة يحاولها خلف بوابة الموافقة نفسها.`,
			],
			govTitle: `الحوكمة والامتثال`,
			govPara: `الرقابة البشرية ليست تفضيلاً تشغيلياً فحسب، بل متطلب تنظيمي. تمنح بوابات الموافقة الرقابة البشرية في المادة 14 من قانون الذكاء الاصطناعي الأوروبي تطبيقاً ملموساً: شخص محدد بالاسم يصرح بإجراء بعينه، ويُسجَّل القرار. وبالاقتران مع <a href="/enterprise/compliance/">إطار الامتثال</a> في EDDI ومسار التدقيق HMAC-SHA256، يمكنك أن تثبت للمدقق ليس فقط ما فعله الوكيل، بل من سمح به ومتى.`,
		},
		scheduling: {
		...
		whyEddi: {
			...
			items: [
				...
				'<strong>84 أداة MCP</strong>: تحكم أصلي كامل بالذكاء الاصطناعي عبر بروتوكول سياق النموذج',
				'<strong>أمان مؤسسي</strong>: OIDC، خزنة، مسارات تدقيق، بدون eval()',
				'<strong>متعدد المستخدمين بالتصميم</strong>: مساحات عمل لكل مستخدم مع المشاركة، وConnections تتيح للوكلاء العمل ببيانات اعتماد كل مستخدم الخاصة',
			...
			// Comparison table
			comparisonTitle: 'EDDI مقابل أُطر عمل الوكلاء التقليدية',
			comparisonHeaders: { dimension: 'البُعد', frameworks: 'أُطر Python/Node', eddi: 'EDDI' },
			comparisonRows: [
				{ dimension: 'التزامن', frameworks: 'GIL أو حلقة أحداث أحادية الخيط', eddi: 'خيوط Java 25 الافتراضية، توازٍ حقيقي على مستوى نظام التشغيل' },
				{ dimension: 'منطق الوكيل', frameworks: 'مضمّن في شفرة التطبيق', eddi: 'تكوينات JSON مُدارة بالإصدارات، حدّث السلوك دون إعادة نشر' },
				{ dimension: 'نموذج الأمان', frameworks: 'يعتمد على تنفيذ شفرة معزول', eddi: 'لا تنفيذ شفرة ديناميكي؛ خزنة بتشفير مغلف وحماية من SSRF' },
				{ dimension: 'الامتثال', frameworks: 'يتطلب تنفيذاً مخصصاً', eddi: 'بنية تحتية لـ GDPR و HIPAA وقانون الذكاء الاصطناعي الأوروبي مدمجة' },
				{ dimension: 'مسار التدقيق', frameworks: 'تسجيل على مستوى التطبيق', eddi: 'دفتر أستاذ غير قابل للتغيير بـ HMAC-SHA256 مع توقيع تشفيري للوكلاء' },
			...
			rfpItems: [
				{ category: 'البنية المعمارية', question: 'هل تنفذ المنصة شفرة مقدمة من المستخدم في وقت التشغيل؟', eddiAnswer: 'لا. يستخدم EDDI تكوين JSON تصريحياً فقط، صفر eval()، صفر كتل تنفيذ شفرة.' },
				{ category: 'الأداء', question: 'كيف تتعامل المنصة مع آلاف محادثات الوكلاء المتزامنة؟', eddiAnswer: 'توفر خيوط Java 25 الافتراضية توازياً حقيقياً على مستوى نظام التشغيل لملايين العمليات المتزامنة كثيفة الإدخال/الإخراج.' },
				{ category: 'التكامل', question: 'هل يمكن للوكلاء استهلاك أدوات وخدمات خارجية عبر معايير مفتوحة؟', eddiAnswer: '84 أداة MCP، بروتوكول A2A، توليد واستهلاك OpenAPI 3.1، و OAuth 2.0/OIDC، جميعها معايير مفتوحة، إضافة إلى واجهة API متوافقة مع OpenAI لأي عميل OpenAI.' },
				{ category: 'خصوصية البيانات', question: 'كيف تُنفَّذ حقوق أصحاب البيانات (المحو، التصدير، التقييد)؟', eddiAnswer: 'واجهة REST API موحدة تتتالى عبر جميع مخازن البيانات الخمسة. نقطة نهاية واحدة لـ GDPR و CCPA و LGPD و PIPEDA وأكثر من 15 إطاراً.' },
			...
			tcoBuildItems: ['\u0637\u0628\u0642\u0629 REST API \u0645\u062e\u0635\u0635\u0629 (2\u20134 \u0623\u0633\u0627\u0628\u064a\u0639)','\u0646\u0638\u0627\u0645 \u0645\u0635\u0627\u062f\u0642\u0629 \u0648 RBAC (2\u20133 \u0623\u0633\u0627\u0628\u064a\u0639)','\u0627\u0633\u062a\u0645\u0631\u0627\u0631\u064a\u0629 \u062d\u0627\u0644\u0629 \u0627\u0644\u0645\u062d\u0627\u062f\u062b\u0629 (1\u20132 \u0623\u0633\u0628\u0648\u0639)','\u0645\u0633\u0627\u0631 \u062a\u062f\u0642\u064a\u0642 \u0648\u062a\u0633\u062c\u064a\u0644 \u0627\u0645\u062a\u062b\u0627\u0644 (2\u20134 \u0623\u0633\u0627\u0628\u064a\u0639)','\u0648\u0627\u062c\u0647\u0629 \u0625\u062f\u0627\u0631\u0629 \u0644\u063a\u064a\u0631 \u0627\u0644\u0645\u0637\u0648\u0631\u064a\u0646 (4\u20138 \u0623\u0633\u0627\u0628\u064a\u0639)','\u062a\u0643\u0627\u0645\u0644 \u0625\u062f\u0627\u0631\u0629 \u0627\u0644\u0623\u0633\u0631\u0627\u0631 (1\u20132 \u0623\u0633\u0628\u0648\u0639)','\u062a\u0648\u0633\u0639 \u0623\u0641\u0642\u064a \u0648\u062a\u0646\u0633\u064a\u0642 (2\u20134 \u0623\u0633\u0627\u0628\u064a\u0639)','\u0635\u064a\u0627\u0646\u0629 \u0645\u0633\u062a\u0645\u0631\u0629 \u0648\u062a\u0631\u0642\u064a\u0639 \u0623\u0645\u0646\u064a'],
		...
		vsAlternatives: {
			...
			heading2: 'مقارنة بأدوات البناء المرئية',
			heading2sub: 'Flowise \u00b7 n8n \u00b7 \u0645\u0646\u0635\u0627\u062a \u0645\u0634\u0627\u0628\u0647\u0629',
			para2: 'أدوات البناء المرئية تجعل النماذج الأولية سريعة. ومع ذلك، تفرض بنيتها قيوداً على نطاق المؤسسات.',

			builderComparisonTitle: 'مقارنة البنية المعمارية',
			builderComparisonHeaders: { dimension: 'البُعد', builders: 'أدوات البناء المرئية', eddi: 'EDDI' },
			builderComparisonRows: [
				{ dimension: 'بيئة التشغيل', builders: 'حلقة أحداث Node.js أحادية الخيط', eddi: 'JVM مع ملايين الخيوط الافتراضية (Project Loom)' },
				{ dimension: 'نموذج التزامن', builders: 'استدعاءات غير متزامنة تُحظر عند المهام كثيفة المعالجة', eddi: 'توازٍ حقيقي على مستوى نظام التشغيل، الخيوط الافتراضية تتنازل بسلاسة أثناء انتظار الإدخال/الإخراج' },
				{ dimension: '\u062a\u0646\u0641\u064a\u0630 \u0627\u0644\u0634\u0641\u0631\u0629', builders: 'eval() \u062f\u064a\u0646\u0627\u0645\u064a\u0643\u064a / \u0643\u062a\u0644 \u0634\u0641\u0631\u0629 \u0644\u0644\u0645\u0646\u0637\u0642 \u0627\u0644\u0645\u062e\u0635\u0635', eddi: '\u0635\u0641\u0631 eval()، \u0633\u0644\u0648\u0643 \u0627\u0644\u0648\u0643\u064a\u0644 \u0647\u0648 \u062a\u0643\u0648\u064a\u0646 JSON \u062a\u0635\u0631\u064a\u062d\u064a \u0641\u0642\u0637' },
				{ dimension: 'الوضع الأمني', builders: 'ثغرات CVE حرجة موثقة علناً عبر المنصات الرئيسية', eddi: 'لا تنفيذ شفرة ديناميكي، يزيل فئات كاملة من الثغرات بالتصميم' },
				{ dimension: 'المصادقة', builders: 'مصادقة أساسية أو إضافات مجتمعية', eddi: 'OIDC/Keycloak مؤسسي مع RBAC (أدوار admin و editor و viewer)' },
				{ dimension: 'قاعدة البيانات', builders: 'SQLite (بعضها يدعم PostgreSQL)', eddi: 'MongoDB أو PostgreSQL، التبديل بمتغير بيئة واحد' },
				{ dimension: 'مسار التدقيق', builders: 'تسجيل على مستوى التطبيق', eddi: 'دفتر أستاذ تدقيق تشفيري غير قابل للتغيير بـ HMAC-SHA256' },
				{ dimension: 'الامتثال', builders: 'يتطلب تنفيذاً يدوياً', eddi: 'بنية تحتية لـ GDPR و HIPAA وقانون الذكاء الاصطناعي الأوروبي مدمجة، دعم أكثر من 15 إطاراً' },
			],
			...
			heading3: 'مقارنة بمكتبات وأُطر الشفرة',
			...
			libraryGapItems: [
				'وحدات تحكم REST API', 'المصادقة (OIDC، RBAC)', 'إدارة حالة المحادثة',
				'تسجيل التدقيق', 'واجهة الإدارة', 'إدارة الأسرار',
				'التوسع الأفقي', 'تتبع التكلفة', 'واجهة API لامتثال GDPR', 'تنفيذ دائم',
			],

			libraryComparisonTitle: 'مقارنة الأُطر',
			libraryComparisonHeaders: { framework: 'الإطار', abstraction: 'التجريد', learning: 'منحنى التعلم', state: 'الحالة والذاكرة', production: 'البنية التحتية للإنتاج' },
			libraryComparisonRows: [
				{ framework: 'LangGraph', abstraction: '\u0639\u0642\u062f \u0648\u062d\u0648\u0627\u0641 (DAG)', learning: '\u0645\u062a\u0648\u0633\u0637 \u0625\u0644\u0649 \u0639\u0627\u0644\u064d', state: '\u0627\u0633\u062a\u0645\u0631\u0627\u0631\u064a\u0629 \u0645\u062f\u0645\u062c\u0629', production: '\u064a\u062a\u0637\u0644\u0628 \u0628\u0646\u064a\u0629 \u062a\u062d\u062a\u064a\u0629 \u0645\u062e\u0635\u0635\u0629' },
				{ framework: 'CrewAI', abstraction: 'تفويض قائم على الأدوار', learning: 'منخفض', state: 'مؤقت', production: 'موجه للنماذج الأولية' },
			...
			heading4: 'مقارنة بمنصات الذكاء الاصطناعي السحابية',
			...
			cloudComparisonTitle: 'السيادة وقابلية النقل',
			...
			cloudComparisonRows: [
				...
				{ dimension: 'جاهز للبيئات المعزولة', cloud: 'غير ممكن دون تخصيص كبير', eddi: 'نشر كامل دون اتصال مع Ollama أو Jlama للاستدلال المحلي' },
			],
		...
		compliance: {
			...
			euAiActItems: [
				...
				'<strong>الرقابة البشرية</strong>: بوابات موافقة على مستوى الدورة واستدعاء الأداة ومرحلة المجموعة، إضافة إلى المراجعة البشرية والتدخل والإيقاف الطارئ في واجهة الإدارة (المادة 14، الرقابة البشرية)',
		...
		trust: {
			...
			timelineDesc: 'في تطوير مستمر منذ 2006 ومفتوح المصدر منذ 2018، قبل عصر LLM بفترة طويلة.',
			timeline: [
				{ year: '2006', text: '<strong>تأسيس المشروع</strong> في أوروبا، أبحاث مبكرة في إدارة الحوار وحالة المحادثة.' },
				{ year: '2008', text: 'احتضان في <strong>inits.at</strong> (حاضنة أعمال جامعية) مع إشراف أكاديمي، مع التركيز على الهندسة البحثية وتطوير المنتجات المستدامة.' },
				{ year: '2018', text: 'اختيار لـ <strong>weXelerate</strong> (برنامج تسريع أوروبي من الدرجة الأولى) \u00b7 إطلاق كمصدر مفتوح تحت Apache 2.0.' },
				{ year: '2018', text: 'أول <strong>هاكاثون EDDI لروبوتات المحادثة</strong> في weXelerate، برعاية مشتركة من مسرّع أعمال ومزود اتصالات كبير.' },
				{ year: '2019', text: '<strong>هاكاثون NYC لروبوتات المحادثة</strong> في مانهاتن في مختبرات الابتكار في Deutsche Bank، برعاية Google وMongoDB. فرق EDDI تحتل المركز الثاني.' },
				{ year: '2020', text: 'مشروع بحث التوأم الرقمي <strong>YouTwinDi</strong> الممول من الاتحاد الأوروبي (European Language Grid).' },
				{ year: '2020', text: 'هاكاثون روبوتات المحادثة عبر الإنترنت، حدث مجتمعي يوسع نطاق EDDI كمصدر مفتوح.' },
				{ year: '2021', text: 'Erasmus+ <strong>EDUBOTS</strong>: EDDI يعمل كمحرك للتجارب متعددة البلدان والأبحاث عبر الجامعات الأوروبية.' },
			...
			institutionsDesc: 'أبحاث ممولة حكومياً وتحقق مؤسسي، ليس مجرد ادعاءات تسويقية.',
			instFFGTitle: 'منحة بحث حكومية FFG',
			instFFGDesc: 'تم نشر EDDI في <strong>SecLearn</strong>، مبادرة تدريب وطنية للأمن السيبراني ممولة من FFG (وكالة بحث حكومية)، بالتعاون مع AIT (معهد أبحاث تكنولوجي وطني).',
			instEUTitle: 'الاتحاد الأوروبي، European Language Grid',
			instEUDesc: 'مشروع بحث التوأم الرقمي <strong>YouTwinDi</strong> الممول من الاتحاد الأوروبي (2020–2021)، يستكشف المساعدين الافتراضيين المستقلين مع ذاكرة دائمة ودعم متعدد اللغات.',
			instEdubotsTitle: 'Erasmus+ EDUBOTS',
			instEdubotsDesc: 'تم استخدام EDDI على نطاق واسع من قبل <strong>EdTech Foundry</strong> (differ.chat)، شريك الاتحاد في Erasmus+ EDUBOTS Knowledge Alliance، لتشغيل روبوتات محادثة مشاركة الطلاب في الجامعات الأوروبية.',
			instWexTitle: 'weXelerate برنامج تسريع أوروبي',
			instWexDesc: 'تم اختياره لـ <strong>weXelerate Batch II</strong> من مركز الابتكار الرائد في وسط أوروبا، لربط LABS.AI بشركاء الأعمال والتحقق من الجدوى التجارية للمنصة.',
			instInitsTitle: 'حاضنة جامعية inits.at',
			instInitsDesc: 'احتضان في حاضنة الأعمال الجامعية في فيينا، مع دعم مؤسسي في المرحلة المبكرة يعطي الأولوية للصرامة الأكاديمية ونمذجة الأعمال المستدامة.',
			instRedHatTitle: 'Red Hat Certified Container',
			instRedHatDesc: 'صورة Docker لـ EDDI <strong>معتمدة من IBM/Red Hat</strong>، وتجتاز فحوصات ما قبل التشغيل الآلية للأمان والاستقرار والجاهزية للنشر المؤسسي، وتُنشر الإصدارات المستقرة في كتالوج Red Hat المعتمد.',
			instUnidoTitle: 'شريك موثوق لدى UNIDO',
			instUnidoDesc: 'تم اختياره من قبل <strong>منظمة الأمم المتحدة للتنمية الصناعية</strong> (UNIDO) كشريك موثوق ضمن الدعوة العالمية للذكاء الاصطناعي الصناعي للجنوب العالمي.',
			enterpriseTitle: 'منشور في بيئة إنتاج المؤسسات',
			enterpriseDesc: 'EDDI يشغّل <strong>تجارب الذكاء الاصطناعي التحادثي</strong> في <a href="https://www.gnowbe.com" target="_blank" rel="noopener">Gnowbe</a>، منصة تمكين المؤسسات. يتعامل EDDI مع تفاعلات الدردشة في الوقت الفعلي مع المتعلمين ومنشئي المحتوى، ويدير التزامن والتوجيه متعدد النماذج وحالة المحادثة على نطاق الإنتاج.',
			enterpriseLinkText: 'اعرف المزيد عن Gnowbe \u2192',
			...
			devE2EDesc: 'اختبارات Playwright المستندة إلى المتصفح لواجهة Manager',
			devApache: 'رخصة Apache 2.0',
			devApacheDesc: 'مفتوح المصدر بالكامل، بدون تقييد البائع',

			ctaTitle: 'هل أنت مستعد للنشر؟',
			ctaGetStarted: 'ابدأ في 5 دقائق',
			ctaGetStartedDesc: 'قم بتثبيت EDDI، وأنشئ أول وكيل لك، وابدأ محادثة.',
			ctaDocs: 'تصفح الوثائق \u2197',
			ctaDocsDesc: 'البنية، أدوات MCP، REST API، أدلة النشر والمزيد.',
		},
		// ─── UNIDO Trusted Partner Page ─────────────────────────
		unido: {
			title: 'شريك موثوق لدى UNIDO، الذكاء الاصطناعي الصناعي للجنوب العالمي',
			description: 'تم اختيار LABS.AI من قبل UNIDO كشريك موثوق للذكاء الاصطناعي الصناعي للجنوب العالمي. تنسيق وكلاء الذكاء الاصطناعي المؤسسي باستخدام EDDI.',

			// Hero
			heroBadge: 'يونيو 2026 · UNIDO',
			heroTitle: 'شريك موثوق لدى UNIDO',
			heroHighlight: 'الذكاء الاصطناعي الصناعي للجنوب العالمي',
			heroDesc: 'تم اختيار LABS.AI من قبل <strong>منظمة الأمم المتحدة للتنمية الصناعية</strong> (UNIDO) كشريك موثوق ضمن <strong>الدعوة العالمية للشركاء الموثوقين، الذكاء الاصطناعي الصناعي للجنوب العالمي</strong>.',

			// Certificate section
			certTitle: 'شهادة تقدير',
			certAlt: 'شهادة تقدير من UNIDO، LABS.AI تم اختيارها كشريك موثوق للذكاء الاصطناعي الصناعي للجنوب العالمي',
			certIssuedBy: 'صادرة عن UNIDO وAIM Global ومعهد شنغهاي لأبحاث الذكاء الاصطناعي في 19 يونيو 2026.',
			...
			whatCard1Title: 'معترف به من وكالة تابعة للأمم المتحدة',
			whatCard1Desc: 'UNIDO هي وكالة متخصصة تابعة للأمم المتحدة تضم 170+ دولة عضواً، مكرسة لتعزيز التنمية الصناعية للحد من الفقر والعولمة الشاملة والاستدامة البيئية.',
			whatCard2Title: 'تحالف AIM Global',
			whatCard2Desc: 'التحالف العالمي للذكاء الاصطناعي للصناعة والتصنيع (AIM Global) يجمع قادة الصناعة والحكومات والأوساط الأكاديمية لدفع التبني المسؤول للذكاء الاصطناعي في قطاعي التصنيع والصناعة عالمياً.',
			whatCard4Title: 'التركيز على الجنوب العالمي',
			whatCard4Desc: 'يستهدف البرنامج تحديداً حلول الذكاء الاصطناعي التي يمكن أن تدفع التنمية الصناعية في الاقتصادات الناشئة، لضمان وصول فوائد التصنيع والرقمنة بالذكاء الاصطناعي إلى الدول النامية.',

			// Organizations
			orgsTitle: 'المنظمات',
			org1Title: 'UNIDO',
			org1Desc: '<strong>منظمة الأمم المتحدة للتنمية الصناعية</strong> (UNIDO) هي وكالة أممية متخصصة تعزز التنمية الصناعية الشاملة والمستدامة. مع 170+ دولة عضواً، تسد UNIDO الفجوة بين الدول النامية والمصنعة.',
			org1Link: 'زيارة UNIDO →',
			org2Title: 'AIM Global',
			org2Desc: '<strong>التحالف العالمي للذكاء الاصطناعي للصناعة والتصنيع</strong> (AIM Global) هو مبادرة متعددة الأطراف تعزز التبني المسؤول للذكاء الاصطناعي في القطاعات الصناعية حول العالم.',
			org2Link: 'زيارة AIM Global →',
			org3Title: 'Shanghai AI Research Institute',
			org3Desc: '<strong>معهد شنغهاي لأبحاث الذكاء الاصطناعي</strong> هو مركز رائد لأبحاث الذكاء الاصطناعي في الصين، يدفع البحث والابتكار المتقدم في الذكاء الاصطناعي وتطبيقاته الصناعية.',

			// SDG Alignment
			sdgTitle: 'متوافق مع أهداف التنمية المستدامة للأمم المتحدة',
			sdgDesc: 'تتمثل مهمة UNIDO في تعزيز أجندة الأمم المتحدة 2030. تدعم منصة EDDI مباشرة أهداف التنمية المستدامة الرئيسية من خلال بنيتها وإمكانية الوصول إليها:',
			sdg9Title: 'SDG 9، الصناعة والابتكار والبنية التحتية',
			sdg9Desc: 'EDDI هو منصة تنسيق الذكاء الاصطناعي الصناعي، التكنولوجيا الأساسية التي اعترفت بها UNIDO. يمكّن المنظمات من بناء بنية تحتية مرنة، وتعزيز التصنيع الشامل، وتشجيع الابتكار من خلال أنظمة ذكاء اصطناعي متاحة وجاهزة للإنتاج.',
			sdg8Title: 'SDG 8، العمل اللائق والنمو الاقتصادي',
			sdg8Desc: 'من خلال توفير تنسيق ذكاء اصطناعي بمستوى مؤسسي بدون تكاليف ترخيص وبدون اعتماد على السحابة، يمكّن EDDI الاقتصادات المحلية من تبني تحسينات الإنتاجية المدفوعة بالذكاء الاصطناعي دون خلق تبعية لموردي التكنولوجيا الأجانب.',
			sdg10Title: 'SDG 10، الحد من التفاوتات',
			sdg10Desc: 'تهدف مبادرة AIM Global التابعة لـ UNIDO صراحة إلى منع اتساع "الفجوة الرقمية للذكاء الاصطناعي". تضمن البنية المستضافة ذاتياً والمفتوحة المصدر لـ EDDI أن الدول النامية يمكنها نشر نفس قدرات الذكاء الاصطناعي المؤسسي كالدول المصنعة، بدون اشتراكات سحابية باهظة.',
			sdg12Title: 'SDG 12، الاستهلاك والإنتاج المسؤولان',
			sdg12Desc: 'يقوم نظام تتابع النماذج في EDDI بتوجيه الاستعلامات الأبسط تلقائياً إلى نماذج أصغر وأكثر كفاءة، ولا يتصاعد إلى نماذج أكبر وأكثر استهلاكاً للحوسبة إلا عند الحاجة. هذا يقلل الاستهلاك غير الضروري للطاقة ووحدات GPU، مما يساهم في استخدام أكثر مسؤولية للموارد الحوسبية على نطاق واسع.',
			sdg17Title: 'SDG 17، شراكات لتحقيق الأهداف',
			sdg17Desc: 'اختيار الشريك الموثوق لدى UNIDO بحد ذاته يجسد SDG 17، شراكة متعددة الأطراف بين وكالة أممية وتحالف صناعي ومزود تكنولوجيا، يعملون معاً لنقل قدرات الذكاء الاصطناعي إلى الجنوب العالمي من خلال التعاون مفتوح المصدر.',

			// CTA
			ctaTitle: 'هل أنت مستعد لنشر EDDI؟',
			ctaDesc: 'نفس المنصة المعترف بها من UNIDO متاحة لمنظمتك، مفتوحة المصدر، مستضافة ذاتياً، وجاهزة للإنتاج.',
			ctaGetStarted: 'ابدأ في 5 دقائق',
			ctaTrackRecord: 'عرض السجل الحافل الكامل',
		},
	},
	...
	cookieBanner: {
		...
		text: 'نستخدم ملفات تعريف الارتباط لتحسين تجربة التصفح وتحليل حركة المرور. بالنقر على "قبول الكل"، فإنك توافق على استخدامنا لملفات تعريف الارتباط.',
		privacyNote: 'لمزيد من المعلومات، راجع',
		acceptAll: 'قبول الكل',
		manageCookies: 'إدارة ملفات تعريف الارتباط',
		modalTitle: 'إدارة التفضيلات',
		modalDesc: 'يمكنك ضبط إعدادات ملفات تعريف الارتباط أدناه. لا يمكن تعطيل ملفات تعريف الارتباط الضرورية.',
		necessaryLabel: 'ملفات تعريف الارتباط الضرورية',
		necessaryDesc: 'مطلوبة لعمل الموقع بشكل صحيح.',
		analyticsLabel: 'التحليلات والأداء',
	...
	contact: {
		title: 'اتصل بنا',
		description: 'تواصل مع فريق EDDI، ابقَ على اطلاع بالإصدارات والميزات وتنسيق الذكاء الاصطناعي للمؤسسات.',
		heading: 'تواصل معنا',
		subheading: 'هل لديك أسئلة؟ هل تريد معرفة المزيد عن EDDI لمؤسستك؟ تواصل معنا.',
		newsletterTitle: 'ابقَ على اطلاع',
		newsletterDesc: 'احصل على تحديثات حول الإصدارات الجديدة والميزات وأفضل ممارسات تنسيق الذكاء الاصطناعي. بدون رسائل غير مرغوبة، فقط محتوى مفيد.',
		directContactTitle: 'اتصال مباشر',
		directContactDesc: 'تفضل البريد الإلكتروني؟ تواصل معنا مباشرة على:',
		email: 'contact@labs.ai',
		githubTitle: 'مجتمع المصدر المفتوح',
		githubDesc: 'انضم إلى المحادثة على GitHub، أبلغ عن مشاكل أو اطلب ميزات أو ساهم بالكود.',
		githubLink: 'زيارة EDDI على GitHub',
		enterpriseTitle: 'المؤسسات والأعمال التجارية',
		enterpriseDesc: 'هل تحتاج إلى استضافة مُدارة أو اتفاقيات مستوى خدمة (SLA) أو إثبات مفهوم موجّه؟ تحدث مع الفريق الذي يقف وراء EDDI.',
		enterpriseCta: 'تواصل مع فريق المؤسسات',
		privacyNotice: 'بتواصلك معنا فإنك توافق على معالجتنا لبياناتك للرد على استفسارك. راجع',
	},
	...
	legal: {
		...
		imprint: {
			...
			mediaOrientationHeading: 'التوجه الأساسي (§25 MedienG)',
			mediaOrientationText: 'معلومات حول منصة تنسيق الذكاء الاصطناعي EDDI مفتوحة المصدر.',
		...
		privacy: {
			...
			description: 'سياسة الخصوصية لـ EDDI من LABS.AI، وكيفية تعاملنا مع بياناتك.',
			heading: 'سياسة الخصوصية',
			lastUpdated: 'آخر تحديث: 11 أبريل 2026',
			intro: 'في LABS.AI، نلتزم بحماية خصوصيتك وضمان أمان بياناتك الشخصية. توضح سياسة الخصوصية هذه كيفية جمعنا واستخدامنا وحمايتنا لمعلوماتك عند استخدامك لموقع EDDI (<a href="https://eddi.technology">eddi.technology</a>).',

			// 1. Data Controller
			controllerHeading: '1. جهة التحكم في البيانات',
			controllerText: 'جهة التحكم المسؤولة عن معالجة البيانات على هذا الموقع هي:',
			...
			// 2. Data Collection
			collectionHeading: '2. البيانات التي نجمعها',
			collectionProvidedHeading: '2.1 المعلومات التي تقدمها',
			collectionProvidedItems: [
				'معلومات الاتصال (الاسم، البريد الإلكتروني) عند اشتراكك في نشرتنا الإخبارية عبر HubSpot',
				'المعلومات التي تقدمها عند التواصل معنا',
			],
			collectionAutoHeading: '2.2 المعلومات المُجمَّعة تلقائياً',
			collectionAutoItems: [
				'المعلومات التقنية: عنوان IP (مجهول الهوية)، نوع المتصفح، نظام التشغيل، عنوان URL المُحيل',
				'بيانات الاستخدام: الصفحات المُشاهدة، الوقت المُستغرق، مسارات التصفح',
				'تُجمع بيانات التحليلات (Google Analytics وUmami) فقط بعد موافقتك عبر شريط ملفات تعريف الارتباط',
				'تُسجَّل سجلات الخادم لفترة وجيزة من أجل التشغيل الآمن للموقع',
			],

			// 3. Purpose and Legal Basis
			purposeHeading: '3. الغرض والأساس القانوني',
			purposeContractHeading: '3.1 معالجة استفسارات التواصل والعروض التجريبية (المادة 6(1)(ب) والمادة 6(1)(و) من اللائحة العامة لحماية البيانات)',
			purposeContractItems: [
				'الرد على استفسارات التواصل والعروض التجريبية التي ترسلها إلينا: الأساس القانوني هو اتخاذ خطوات تمهيدية للتعاقد بناءً على طلبك (المادة 6(1)(ب)) ومصلحتنا المشروعة في الرد على رسالتك (المادة 6(1)(و))',
			],
			purposeConsentHeading: '3.2 استناداً إلى الموافقة (المادة 6(1)(أ) من اللائحة العامة لحماية البيانات)',
			purposeConsentItems: [
				'Google Analytics: تحليل استخدام الموقع، يُحمَّل فقط بعد موافقتك الصريحة على ملفات تعريف الارتباط',
				'Umami Analytics: تحليل استخدام الموقع، يُحمَّل فقط بعد موافقتك الصريحة على ملفات تعريف الارتباط',
				'النشرة الإخبارية: اتصالات تسويقية عبر HubSpot، تُرسَل فقط بعد اشتراكك الاختياري',
			],
			purposeLegitHeading: '3.3 استناداً إلى المصالح المشروعة (المادة 6(1)(و) من اللائحة العامة لحماية البيانات)',
			purposeLegitItems: [
				'الاستضافة وسجلات الخادم: ضمان التشغيل الآمن والمستقر لموقعنا (المادة 6(1)(و))',
			],

			// 4. Cookies
			cookieHeading: '4. ملفات تعريف الارتباط وتقنيات التتبع',
			cookieIntro: 'نستخدم فئات ملفات تعريف الارتباط وتقنيات التتبع التالية:',
			cookieNecessaryHeading: 'ضرورية للغاية',
			cookieNecessaryDesc: 'ضرورية لعمل الموقع بشكل صحيح. يقتصر هذا على التخزين المحلي لاختيارك للسمة واختيارك للموافقة. بموجب §165 TKG (Telekommunikationsgesetz) لا تتطلب هذه موافقة. لا يمكن تعطيلها.',
			cookieAnalyticsHeading: 'التحليلات والأداء',
			cookieAnalyticsDesc: 'Google Analytics (G-L1011GL1PY) وUmami Analytics: تتبع استخدام الموقع. يُحمَّل كلاهما فقط بعد موافقتك الصريحة عبر شريط ملفات تعريف الارتباط (المادة 6(1)(أ) من اللائحة العامة لحماية البيانات). تُعالَج بيانات Google Analytics بواسطة Google LLC (الولايات المتحدة)؛ وتعتمد عمليات النقل على قرار الكفاية الخاص بإطار خصوصية البيانات بين الاتحاد الأوروبي والولايات المتحدة (EU-US Data Privacy Framework)، مع بنود العقد الموحدة للاتحاد الأوروبي (Standard Contractual Clauses) كخيار احتياطي.',
			cookieMarketingHeading: 'التسويق',
			cookieMarketingDesc: 'لا يُحمَّل تضمين نموذج النشرة الإخبارية ونموذج التواصل عبر HubSpot إلا بعد اشتراكك الاختياري. لا تُستخدم حالياً أي أدوات تتبع تسويقية أخرى.',
			cookieManage: 'يمكنك سحب موافقتك أو تغييرها في أي وقت عبر رابط "إعدادات ملفات تعريف الارتباط" في التذييل، والذي يعيد فتح نافذة التفضيلات.',

			// 5. Third-Party Services
			thirdPartyHeading: '5. خدمات الأطراف الثالثة ومعالجو البيانات',
			thirdPartyIntro: 'نستخدم خدمات الأطراف الثالثة التالية لتشغيل هذا الموقع:',
			thirdPartyItems: [
				'<strong>Google LLC</strong> (الولايات المتحدة، Google Analytics): تحليلات الموقع. تُحمَّل فقط بعد موافقتك. تعتمد عمليات النقل إلى الولايات المتحدة على قرار الكفاية الخاص بإطار خصوصية البيانات بين الاتحاد الأوروبي والولايات المتحدة حيث تحمل Google شهادة DPF، مع بنود العقد الموحدة للاتحاد الأوروبي كخيار احتياطي.',
				'<strong>Umami Software, Inc.</strong> (التحليلات، cloud.umami.is): تحليلات موقع صديقة للخصوصية. تُحمَّل فقط بعد موافقتك.',
				'<strong>HubSpot, Inc.</strong> (الولايات المتحدة، النماذج وإدارة علاقات العملاء): الاشتراك في النشرة الإخبارية ونموذج التواصل. يُحمَّل فقط بعد موافقتك. تعتمد عمليات النقل إلى الولايات المتحدة على قرار الكفاية الخاص بإطار خصوصية البيانات بين الاتحاد الأوروبي والولايات المتحدة حيث تحمل HubSpot شهادة DPF، مع بنود العقد الموحدة للاتحاد الأوروبي كخيار احتياطي.',
				'<strong>Vercel Inc.</strong> (الولايات المتحدة، الاستضافة): استضافة الموقع وتقديمه. يجوز معالجة سجلات وصول الخادم (بما في ذلك عنوان IP) من أجل التشغيل الآمن والموثوق. تعتمد عمليات النقل إلى الولايات المتحدة على بنود العقد الموحدة للاتحاد الأوروبي (المادة 46(2)(ج) من اللائحة العامة لحماية البيانات).',
			],
			thirdPartyDpa: 'لدينا اتفاقيات معالجة بيانات بموجب المادة 28 من اللائحة العامة لحماية البيانات مع هؤلاء المعالجين. تتوفر نسخة من ضمانات النقل عند الطلب.',

			// 6. International Transfers
			transferHeading: '6. عمليات نقل البيانات الدولية',
			transferText: 'يقع بعض مزودي خدماتنا (HubSpot وGoogle ومضيفنا) في الولايات المتحدة. عندما يحمل المستلم شهادة بموجب إطار خصوصية البيانات بين الاتحاد الأوروبي والولايات المتحدة، تعتمد عمليات النقل على قرار الكفاية الصادر عن المفوضية الأوروبية لهذا الإطار (المادة 45 من اللائحة العامة لحماية البيانات). وكخيار احتياطي، نستخدم بنود العقد الموحدة للاتحاد الأوروبي (المادة 46(2)(ج) من اللائحة العامة لحماية البيانات). تتوفر نسخة من هذه الضمانات عند الطلب.',

			// 7. Data Retention
			retentionHeading: '7. الاحتفاظ بالبيانات',
			retentionText: 'نحتفظ ببياناتك الشخصية فقط طالما كان ذلك ضرورياً للأغراض التي جُمعت من أجلها. تُحفظ بيانات استفسارات التواصل والعروض التجريبية فقط طالما لزم الأمر لمعالجة طلبك ولفترة متابعة معقولة، ثم تُحذف. تُحفظ بيانات مشتركي النشرة الإخبارية حتى تُلغي اشتراكك. تُحفظ بيانات التحليلات وفقاً لسياسة الاحتفاظ الخاصة بكل مزود (Google Analytics: حوالي 14 شهراً). تُحفظ سجلات الخادم لفترة وجيزة فقط لأغراض أمنية.',

			// 8. Your Rights
			rightsHeading: '8. حقوقك',
			rightsIntro: 'بموجب اللائحة العامة لحماية البيانات (GDPR)، لديك الحقوق التالية بخصوص بياناتك الشخصية:',
			rightsItems: [
				'<strong>الحق في الوصول</strong> (المادة 15): طلب نسخة من بياناتك الشخصية',
				'<strong>الحق في التصحيح</strong> (المادة 16): طلب تصحيح البيانات غير الدقيقة',
				'<strong>الحق في المحو</strong> (المادة 17): طلب حذف بياناتك الشخصية',
				'<strong>الحق في تقييد المعالجة</strong> (المادة 18): طلب تقييد المعالجة',
				'<strong>الحق في نقل البيانات</strong> (المادة 20): استلام بياناتك بصيغة قابلة للقراءة آلياً',
				'<strong>الحق في الاعتراض</strong> (المادة 21): الاعتراض على المعالجة القائمة على المصالح المشروعة',
				'<strong>الحق في سحب الموافقة</strong> (المادة 7(3)): سحب الموافقة في أي وقت (مثلاً عبر إعدادات ملفات تعريف الارتباط)',
			],
			rightsContact: 'لممارسة أي من هذه الحقوق، يرجى التواصل معنا على <a href="mailto:contact@labs.ai">contact@labs.ai</a>. سنرد على طلبك خلال شهر واحد.',

			// 9. Provision of Data
			provisionHeading: '9. هل تقديم البيانات إلزامي؟',
			provisionText: 'تقديم بيانات الاتصال الخاصة بك أمر اختياري تماماً. ومع ذلك، فهو ضروري إذا كنت تريد منا الرد على استفسارك أو إرسال النشرة الإخبارية إليك. لا يوجد التزام قانوني أو تعاقدي بتقديم البيانات. إذا لم تقدمها، فإن النتيجة الوحيدة هي أننا لن نتمكن من الرد عليك أو إرسال النشرة الإخبارية.',

			// 10. Automated Decision-Making
			automatedHeading: '10. اتخاذ القرار الآلي والتنميط',
			automatedText: 'نحن لا نستخدم اتخاذ القرار الآلي أو التنميط بالمعنى المقصود في المادة 22 من اللائحة العامة لحماية البيانات. لا تخضع بياناتك لأي قرار آلي ينتج عنه آثار قانونية تخصك أو يؤثر عليك بشكل مماثل وملموس.',

			// 11. Data Security
			securityHeading: '11. أمان البيانات',
			securityText: 'نطبق تدابير تقنية وتنظيمية مناسبة لحماية بياناتك الشخصية، بما في ذلك تشفير HTTPS لجميع البيانات أثناء النقل، وضوابط الوصول للأنظمة الإدارية.',

			// 12. Children
			childrenHeading: '12. خصوصية الأطفال',
			childrenText: 'موقعنا غير موجّه للأطفال دون سن 16 عاماً. نحن لا نجمع عن قصد بيانات شخصية من الأطفال.',

			// 13. Changes
			changesHeading: '13. التغييرات على سياسة الخصوصية هذه',
			changesText: 'قد نقوم بتحديث سياسة الخصوصية هذه من وقت لآخر. سنُعلمك بأي تغييرات من خلال نشر السياسة المحدّثة على هذه الصفحة وتحديث تاريخ "آخر تحديث".',

			// 14. Supervisory Authority
			authorityHeading: '14. السلطة الإشرافية',
			authorityText: 'لديك الحق في تقديم شكوى إلى السلطة الإشرافية المختصة. في النمسا، هذه السلطة هي:',
			authorityName: 'هيئة حماية البيانات النمساوية (Datenschutzbehörde)',
			authorityAddress: 'Barichgasse 40-42, 1030 Vienna, Austria',
			authorityUrl: 'https://www.dsb.gv.at',

			// 15. Contact
			contactHeading: '15. التواصل',
			contactText: 'إذا كانت لديك أسئلة حول سياسة الخصوصية هذه أو ممارساتنا في التعامل مع البيانات، يرجى التواصل معنا:',
			contactDetails: 'LABS.AI: حماية البيانات<br>Vienna, Austria<br>Email: <a href="mailto:contact@labs.ai">contact@labs.ai</a>',
		},
	},
};
