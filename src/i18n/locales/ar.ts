...
const ar: TranslationSchema = {
	meta: {
		siteTitle: 'EDDI',
		siteDescription:
			`EDDI ${EDDI_VERSION}، منصة تنسيق وكلاء الذكاء الاصطناعي للمؤسسات. نظام متعدد الوكلاء مستضاف ذاتياً وقائم على التكوين، مع واجهة إدارة مرئية و77 أداة MCP وبنية الأمان أولاً وامتثال تنظيمي مدمج لـ GDPR وقانون الذكاء الاصطناعي الأوروبي وHIPAA وأكثر من 15 إطاراً تنظيمياً.`,
	},
	nav: {
		features: 'الميزات',
		docs: 'التوثيق',
		...
		mcpServer: 'خادم MCP',
		mcpServerDesc: '77 أداة للتحكم الأصلي بالذكاء الاصطناعي',
		...
		codeQualityDesc: '+11,000 اختبار، صفر إخفاقات، >90% تغطية',
		...
		mcpServerMobile: 'خادم MCP (77 أداة)',
		resources: 'الموارد',
	...
	footer: {
		...
		tests: '+11,000 اختبار · صفر إخفاقات',
	...
	home: {
		...
		trustTests: '+11,000 اختبار · 0 إخفاقات',
		...
		faq4A:
			'بروتوكول سياق النموذج (MCP) هو معيار مفتوح يسمح لمساعدي الذكاء الاصطناعي مثل Claude Desktop وإضافات IDE والعملاء المخصصين بالتفاعل مع الأدوات الخارجية برمجياً. يكشف EDDI 77 أداة MCP تشمل إدارة المحادثات وإدارة الوكلاء وأتمتة الإعداد وإدارة الجداول والتشخيصات.',
	...
	gettingStarted: {
		...
		step1Desc: 'أسرع طريقة لتشغيل EDDI هي <strong>مُثبِّت الأمر الواحد</strong>. يقوم بإعداد EDDI + قاعدة البيانات التي تختارها عبر Docker Compose، وينشر وكيلاً أولياً، ويرشدك خلال الإعداد:',
		...
		step2Desc: 'قم بتوصيل مساعدك الذكي بـ <strong>77 أداة MCP</strong> في EDDI. يعتمد التكوين على دعم النقل لعميلك:',
		...
		step2After: 'الآن يمكنك التفاعل مع <strong>77 أداة MCP</strong> في EDDI مباشرة من مساعدك الذكي.',
		step2DocsLink:
		...
		nextMcpServerDesc: 'تصفح جميع أدوات MCP الـ 77',
		nextDocs: 'التوثيق ↗',
	...
	featuresOverview: {
		...
		description:
			'كل القدرات التي تجعل EDDI منسّق الذكاء الاصطناعي للمؤسسات، واجهة EDDI Manager، التكوين-كشفرة، 77 أداة MCP، بنية الأمان أولاً، والمزيد.',
		...
		cqCardDesc: '<strong>+11,000 اختبار بصفر إخفاقات.</strong> صفر تنبيهات Checkstyle. >90% تغطية الشفرة. CI/CD مطبق في كل دمج.',
		aiCardTitle: '🧩 جاهز للذكاء الاصطناعي',
		aiCardDesc: '77 أداة MCP، أنماط CRUD قابلة للتنبؤ، واجهات API ذاتية التوثيق. <strong>مصمم لوكلاء البرمجة</strong> للعمل معه.',
	},
	pages: {
		manager: {
			title: 'مدير EDDI',
		...
		mcpServer: {
			...
			para1:
				'بروتوكول سياق النموذج (MCP) هو معيار مفتوح يسمح لمساعدي الذكاء الاصطناعي بالتفاعل مع الأدوات الخارجية. ينفذ EDDI خادم MCP شامل مع <strong>77 أداة</strong> تغطي كل جانب من جوانب المنصة.',
		...
		multiAgent: {
			...
			para2: 'يدعم EDDI <strong>محادثات جماعية متعددة الوكلاء</strong> مع 6 أنماط مناقشة مدمجة، إنشاء وكلاء ديناميكي، وهياكل مجموعات متداخلة ووكيل وصفي يشغّل المنصة نفسها:',
			items2: [
		...
		codeQuality: {
			title: 'جودة الشفرة',
			description: '+11,000 اختبار بصفر إخفاقات. صفر تنبيهات Checkstyle. >90% تغطية الشفرة. بوابات جودة CI/CD مطبقة في كل دمج.',
			...
			items: [
				'<strong>+11,000 اختبار</strong>: تغطية وحدات وتكامل وشاملة',
				'<strong>صفر إخفاقات</strong>: CI نظيف في كل بناء',
				'<strong>تطبيق Checkstyle</strong>: صفر تنبيهات، قواعد صارمة مطبقة في كل بناء',
				'<strong>اختبارات أدوات MCP</strong>: تغطية شاملة لجميع أدوات MCP الـ 77',
				'<strong>بوابات جودة CI/CD</strong>: فحوصات آلية تمنع التراجع',
			],
		},
		aiReady: {
			title: 'بنية جاهزة للذكاء الاصطناعي',
			description: '77 أداة MCP، أنماط CRUD قابلة للتنبؤ، واجهات API ذاتية التوثيق. مصمم من الألف إلى الياء لوكلاء البرمجة.',
			...
			items: [
				...
				'<strong>MCP أولاً</strong>: 77 أداة مصممة للتكامل مع مساعدي الذكاء الاصطناعي',
		...
		humanInTheLoop: {
			...
			description: `أوقف دورة مؤقتاً، أو اضبط بوابة على استدعاء أداة بعينه، أو اشترط اعتماداً بشرياً على مرحلة نقاش. تدفقات موافقة مع سياسات مهلة وبطاقات Slack وحالة تصمد أمام إعادة التشغيل، ضمن EDDI ${EDDI_LATEST_VERSION}.`,
			heading1: `استقلالية مع زر إيقاف`,
			para1: `تبقى الوكلاء المستقلة مفيدة حتى اللحظة التي تنفذ فيها إجراءً لا يمكن التراجع عنه. يقدم EDDI ${EDDI_LATEST_VERSION} <strong>الحوكمة بمشاركة بشرية</strong>: بوابات موافقة صريحة على ثلاثة مستويات من التفصيل، تسندها سياسات المهلة وكشف الحلقات وحالة تبقى بعد إعادة التشغيل. الموافقات تكوين، وليست شفرة تطبيق مخصصة.`,
			...
			opsItems: [
				...
				`<strong>الموافقات عبر MCP</strong>: يمكن للعملاء الخارجيين عرض الموافقات المعلقة وقبولها أو رفضها عبر أدوات MCP، وهي جزء من الأدوات الـ77، مما يحول بيئة التطوير أو عميل الوكيل إلى مستوى تحكم.`,
			],
		...
		whyEddi: {
			...
			items: [
				...
				'<strong>77 أداة MCP</strong>: تحكم أصلي كامل بالذكاء الاصطناعي عبر بروتوكول سياق النموذج',
			...
			comparisonRows: [
				...
				{ dimension: 'النشر', frameworks: 'pip/npm + بنية تحتية يدوية', eddi: 'تثبيت Docker بأمر واحد، جاهز لـ Kubernetes/OpenShift' },
			],
			// LLM Providers
			...
			rfpItems: [
				...
				{ category: 'التكامل', question: 'هل يمكن للوكلاء استهلاك أدوات وخدمات خارجية عبر معايير مفتوحة؟', eddiAnswer: '77 أداة MCP، بروتوكول A2A، توليد واستهلاك OpenAPI 3.1، و OAuth 2.0/OIDC، جميعها معايير مفتوحة.' },
		...
		vsAlternatives: {
			...
			libraryComparisonRows: [
				...
				{ framework: 'EDDI', abstraction: 'منصة تنسيق', learning: 'منخفض (التكوين-كشفرة)', state: 'ذاكرة مستمرة + توحيد الأحلام', production: 'مُغلف بالكامل' },
			],
		...
		trust: {
			...
			timeline: [
				...
				{ year: '2026', text: '<strong>v6</strong>: 77 أداة MCP، بروتوكول A2A، 6 أنماط مناقشة بما في ذلك Task Force، وكلاء ديناميكيون، واجهة إدارة بصرية، تتابع النماذج.' },
			...
			instRedHatDesc: 'صورة Docker لـ EDDI <strong>معتمدة من IBM/Red Hat</strong>، وتجتاز فحوصات ما قبل التشغيل الآلية للأمان والاستقرار والجاهزية للنشر المؤسسي.',
		...
		unido: {
			...
			whatCard3Title: 'عرض في WAIC 2026',
			whatCard3Desc: 'مؤتمر الذكاء الاصطناعي العالمي (WAIC) في شنغهاي هو أحد أكثر فعاليات الذكاء الاصطناعي تأثيراً عالمياً، يجمع باحثين رائدين وصانعي سياسات وقادة صناعة لتشكيل مستقبل الذكاء الاصطناعي.',
			...
			org4Title: 'WAIC 2026',
			org4Desc: '<strong>مؤتمر الذكاء الاصطناعي العالمي</strong> (WAIC) هو أحد أكثر فعاليات الذكاء الاصطناعي هيبة عالمياً، يُعقد سنوياً في شنغهاي. WAIC 2026 يجمع باحثين من الطراز الأول وصانعي سياسات وقادة صناعة.',
			org4Link: 'زيارة WAIC →',
