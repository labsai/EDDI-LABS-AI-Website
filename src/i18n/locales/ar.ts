...
// ─── New Feature Pages ────────────────────────────────────
		...
		trust: {
			...
			timeline: [
				...
				{ year: '2008', text: 'احتضان في <strong>حاضنة أعمال جامعية</strong> مع إشراف أكاديمي، مع التركيز على الهندسة البحثية وتطوير المنتجات المستدامة.' },
				{ year: '2018', text: 'اختيار لـ<strong>برنامج تسريع أوروبي من الدرجة الأولى</strong> \u00b7 إطلاق كمصدر مفتوح تحت Apache 2.0.' },
				{ year: '2018', text: 'أول <strong>هاكاثون EDDI لروبوتات المحادثة</strong> — برعاية مشتركة من مسرّع أعمال ومزود اتصالات كبير.' },
			...
			instFFGTitle: 'منحة بحث حكومية',
			instFFGDesc: 'تم نشر EDDI في <strong>SecLearn</strong>، مبادرة تدريب وطنية للأمن السيبراني ممولة من وكالة بحث حكومية، بالتعاون مع معهد أبحاث تكنولوجي وطني.',
