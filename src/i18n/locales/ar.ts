...
const ar: TranslationSchema = {
	...
	nav: {
		...
		codeQualityDesc: '+9,000 اختبار، صفر إخفاقات، >90% تغطية',
	...
	home: {
		...
		unidoCalloutDesc: 'تم اختيار LABS.AI من قبل منظمة الأمم المتحدة للتنمية الصناعية (UNIDO) كشريك موثوق للذكاء الاصطناعي الصناعي للجنوب العالمي — مع عرض EDDI في WAIC 2026 في شنغهاي.',
	...
	pages: {
		...
		codeQuality: {
			title: 'جودة الشفرة',
			description: '+9,000 اختبار بصفر إخفاقات. صفر تنبيهات Checkstyle. >90% تغطية الشفرة. بوابات جودة CI/CD مطبقة في كل دمج.',
		...
		trust: {
			...
			statTests: 'اختبارات \u00b7 0 إخفاقات',
			statProviders: 'مزودو LLM',
			statCertified: 'معتمد من Red Hat',
			timelineTitle: 'عقدان من الهندسة',
			timelineDesc: 'ما يقرب من عقدين من الهندسة المستمرة — قبل عصر LLM بفترة طويلة.',
			timeline: [
			...
			instUnidoDesc: 'تم اختياره من قبل <strong>منظمة الأمم المتحدة للتنمية الصناعية</strong> (UNIDO) كشريك موثوق ضمن الدعوة العالمية للذكاء الاصطناعي الصناعي للجنوب العالمي. معروض في WAIC 2026 · شنغهاي.',
		...
		unido: {
			...
			description: 'تم اختيار LABS.AI من قبل UNIDO كشريك موثوق للذكاء الاصطناعي الصناعي للجنوب العالمي. تنسيق وكلاء الذكاء الاصطناعي المؤسسي باستخدام EDDI — معروض في WAIC 2026 في شنغهاي.',

			// Hero
			heroBadge: 'يونيو 2026 · WAIC شنغهاي',
			...
			whatCard1Title: 'تحقق مؤسسي أممي',
			whatCard1Desc: 'UNIDO هي وكالة متخصصة تابعة للأمم المتحدة تضم 172 دولة عضواً، مكرسة لتعزيز التنمية الصناعية للحد من الفقر والعولمة الشاملة والاستدامة البيئية.',
			...
			orgsTitle: 'المنظمات',
			org1Title: 'UNIDO',
			org1Desc: '<strong>منظمة الأمم المتحدة للتنمية الصناعية</strong> (UNIDO) هي وكالة أممية متخصصة تعزز التنمية الصناعية الشاملة والمستدامة. مع 172 دولة عضواً، تسد UNIDO الفجوة بين الدول النامية والمصنعة.',
			...
			ctaDesc: 'نفس المنصة المعترف بها من الأمم المتحدة متاحة لمنظمتك — مفتوحة المصدر، مستضافة ذاتياً، وجاهزة للإنتاج.',
			ctaGetStarted: 'ابدأ في 5 دقائق',
