...
// ─── New Feature Pages ────────────────────────────────────
		...
		trust: {
			...
			timelineTitle: 'من فيينا إلى العالم',
			timelineDesc: 'ما يقرب من عقدين من الهندسة المستمرة — قبل عصر LLM بفترة طويلة.',
			timeline: [
				{ year: '2006', text: '<strong>تأسيس المشروع</strong> في فيينا، النمسا — أبحاث مبكرة في إدارة الحوار وحالة المحادثة.' },
				{ year: '2008', text: 'احتضان في <strong>inits.at</strong>، حاضنة الأعمال الجامعية في فيينا، مع الصرامة الأكاديمية والدعم المؤسسي.' },
				{ year: '2018', text: 'اختيار لمسرع <strong>weXelerate Batch II</strong> \u00b7 إطلاق كمصدر مفتوح تحت Apache 2.0.' },
				{ year: '2018', text: 'أول <strong>هاكاثون EDDI لروبوتات المحادثة</strong> في weXelerate، فيينا — برعاية weXelerate وT-Mobile.' },
			...
			instFFGTitle: 'وكالة تعزيز البحث النمساوية (FFG)',
			instFFGDesc: 'تم نشر EDDI في <strong>SecLearn</strong>، مبادرة تدريب وطنية للأمن السيبراني ممولة من FFG، بالتعاون مع معهد التكنولوجيا النمساوي (AIT).',
