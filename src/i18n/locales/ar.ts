...
const ar: TranslationSchema = {
	meta: {
		siteTitle: 'EDDI',
		siteDescription:
			`EDDI ${EDDI_VERSION}، منصة تنسيق وكلاء الذكاء الاصطناعي للمؤسسات. نظام متعدد الوكلاء مستضاف ذاتياً وقائم على التكوين، مع واجهة إدارة مرئية و65 أداة MCP وبنية الأمان أولاً وامتثال تنظيمي مدمج لـ GDPR وقانون الذكاء الاصطناعي الأوروبي وHIPAA وأكثر من 15 إطاراً تنظيمياً.`,
	},
	nav: {
		features: 'الميزات',
		docs: 'التوثيق',
		...
		codeQualityDesc: '+10,000 اختبار، صفر إخفاقات، >90% تغطية',
	...
	footer: {
		...
		tests: '+10,000 اختبار · صفر إخفاقات',
	...
	home: {
		...
		trustTests: '+10,000 اختبار · 0 إخفاقات',
	...
	featuresOverview: {
		...
		cqCardDesc: '<strong>+10,000 اختبار بصفر إخفاقات.</strong> صفر تنبيهات Checkstyle. >90% تغطية الشفرة. CI/CD مطبق في كل دمج.',
	...
	pages: {
		...
		codeQuality: {
			title: 'جودة الشفرة',
			description: '+10,000 اختبار بصفر إخفاقات. صفر تنبيهات Checkstyle. >90% تغطية الشفرة. بوابات جودة CI/CD مطبقة في كل دمج.',
			...
			items: [
				'<strong>+10,000 اختبار</strong>: تغطية وحدات وتكامل وشاملة',
		...
		whyEddi: {
			...
			rfpItems: [
				...
				{ category: 'التكامل', question: 'هل يمكن للوكلاء استهلاك أدوات وخدمات خارجية عبر معايير مفتوحة؟', eddiAnswer: '65 أداة MCP، بروتوكول A2A، توليد واستهلاك OpenAPI 3.1، و OAuth 2.0/OIDC، جميعها معايير مفتوحة.' },
