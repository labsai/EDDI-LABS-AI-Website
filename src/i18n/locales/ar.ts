...
const ar: TranslationSchema = {
	...
	nav: {
		...
		codeQualityDesc: '+5,100 اختبار، صفر إخفاقات',
	...
	footer: {
		...
		tests: '+5,100 اختبار · صفر إخفاقات',
	...
	home: {
		...
		trustTests: '+5,100 اختبار · 0 إخفاقات',
	...
	featuresOverview: {
		...
		cqCardDesc: '<strong>+5,100 اختبار بصفر إخفاقات.</strong> صفر تنبيهات Checkstyle. CI/CD مطبق في كل دمج.',
	...
	pages: {
		...
		codeQuality: {
			title: 'جودة الشفرة',
			description: '+5,100 اختبار بصفر إخفاقات. صفر تنبيهات Checkstyle. بوابات جودة CI/CD مطبقة في كل دمج.',
