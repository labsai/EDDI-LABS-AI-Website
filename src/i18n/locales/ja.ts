...
// ─── New Feature Pages ────────────────────────────────────
		...
		trust: {
			...
			timelineTitle: 'ウィーンから世界へ',
			timelineDesc: 'LLM時代のはるか以前から、約20年間の継続的エンジニアリング。',
			timeline: [
				{ year: '2006', text: 'オーストリア・ウィーンで<strong>プロジェクト設立</strong> — 対話管理と会話状態の初期研究。' },
				{ year: '2008', text: 'ウィーンの大学系ビジネスインキュベーター<strong>inits.at</strong>でインキュベート。学術的厳密さと機関支援。' },
				{ year: '2018', text: '<strong>weXelerate Batch II</strong>アクセラレーターに選出 \u00b7 Apache 2.0でオープンソースとして公開。' },
				{ year: '2018', text: 'weXelerate（ウィーン）で初の<strong>EDDIチャットボットハッカソン</strong> — weXelerateとT-Mobileがスポンサー。' },
			...
			instFFGTitle: 'オーストリア研究促進庁（FFG）',
			instFFGDesc: 'EDDIは<strong>SecLearn</strong>で展開されました。FFGが助成し、Austrian Institute of Technology（AIT）と共同で実施された国家サイバーセキュリティ訓練イニシアチブです。',
			...
			instInitsTitle: 'inits.atインキュベーター',
