...
const ja: TranslationSchema = {
	...
	nav: {
		...
		codeQuality: 'コード品質',
		codeQualityDesc: '1,700以上のテスト、失敗ゼロ',
		aiReady: 'AI対応',
	...
	featuresOverview: {
		...
		cqCardTitle: '🧪 コード品質',
		cqCardDesc: '<strong>1,700以上のテストで失敗ゼロ。</strong>Checkstyle警告ゼロ。CI/CDをすべてのマージで強制。',
		aiCardTitle: '🧩 AI対応',
	...
	pages: {
		...
		codeQuality: {
			title: 'コード品質',
			description: '1,700以上のテストで失敗ゼロ。Checkstyle警告ゼロ。CI/CD品質ゲートをすべてのマージで強制。',
			...
			heading2: '品質メトリクス',
			items: [
				'<strong>1,700以上のテスト</strong> — ユニット、統合、エンドツーエンドのカバレッジ',
