...
// ─── New Feature Pages ────────────────────────────────────
		...
		trust: {
			...
			timeline: [
				{ year: '2006', text: 'ヨーロッパで<strong>プロジェクト設立</strong> — 対話管理と会話状態の初期研究。' },
				{ year: '2008', text: '<strong>大学ビジネスインキュベーター</strong>でインキュベート。学術的監督の下、研究レベルのエンジニアリングと持続可能な製品開発に注力。' },
				{ year: '2018', text: '<strong>ヨーロッパトップクラスのアクセラレータープログラム</strong>に選出 \u00b7 Apache 2.0でオープンソースとして公開。' },
				{ year: '2018', text: '初の<strong>EDDIチャットボットハッカソン</strong> — アクセラレーターと大手通信事業者の共同スポンサー。' },
			...
			instFFGTitle: '政府研究助成金',
			instFFGDesc: 'EDDIは<strong>SecLearn</strong>で展開されました。政府の研究機関が助成し、国立技術研究所と共同で実施された国家サイバーセキュリティ訓練イニシアチブです。',
